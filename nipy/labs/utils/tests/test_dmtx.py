...
from ..design_matrix import (EventRelatedParadigm, BlockParadigm, 
                             convolve_regressors, DesignMatrix, 
                             dmtx_light, dmtx_from_csv)
...
def test_convolve_regressors():
    ...
    f, names = convolve_regressors(paradigm, 'Canonical', 100)
