...
We closely follow SPM implementation

Fixme
-----
consistent use of onset
explicit parametric mopdulation
...
def _orthogonalize(X):
    ...
    Note
    ----
    X is changes in place. the columns are not normalized
    """
    if X.size == X.shape[0]:
        return X
...
def compute_regressor(exp_condition, hrf_model, frametimes, con_id='cond',
                      onset=0, oversampling=16, fir_delays=None):
