...
def average_link_distance_segment(D, stop=-1, qmax=1, verbose=0):
    ...
    stop: float, optional,
          stopping criterion, i.e. distance threshold at which
          further merges are forbidden. By default, all merges are performed
    qmax: int, optional,
          the number of desired clusters (in the limit of stop)
...
def maximum_link_distance_segment(D, stop=-1, qmax=1, verbose=0):
    ...
    qmax: int, optional,
          the number of desired clusters (in the limit of stop criterion)
    stop: float, optional,
          stopping criterion, i.e. distance threshold at which
          further merges are forbidden. By default all merges are performed
