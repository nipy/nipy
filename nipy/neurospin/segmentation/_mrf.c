/* Generated by Cython 0.12.1 on Sat Jul 24 02:24:40 2010 */
...
/* "d:\home\Alexis\git\nipy\nipy\neurospin\segmentation\_mrf.pyx":36
 * 
 * 
...
static PyObject *__pyx_pf_4nipy_9neurospin_12segmentation_4_mrf__ve_step(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\segmentation\_mrf.pyx":38
 * def _ve_step(ppm, ref, XYZ, double beta, int copy, int hard, mix=None):
 * 
 *     if not ppm.flags['C_CONTIGUOUS'] or not ppm.dtype=='double':             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_3) {
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\segmentation\_mrf.pyx":39
 * 
 *     if not ppm.flags['C_CONTIGUOUS'] or not ppm.dtype=='double':
 *         raise ValueError('ppm array should be double C-contiguous')             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\segmentation\_mrf.pyx":41
 *         raise ValueError('ppm array should be double C-contiguous')
 * 
 *     if not ref.flags['C_CONTIGUOUS'] or not ref.dtype=='double':             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_3) {
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\segmentation\_mrf.pyx":42
 * 
 *     if not ref.flags['C_CONTIGUOUS'] or not ref.dtype=='double':
 *         raise ValueError('ref array should be double C-contiguous')             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\segmentation\_mrf.pyx":44
 *         raise ValueError('ref array should be double C-contiguous')
 * 
 *     XYZ = np.asarray(XYZ, dtype='int')             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\segmentation\_mrf.pyx":47
 * 
 *     ve_step(<ndarray>ppm, <ndarray>ref, <ndarray>XYZ, <ndarray>mix,
 *              beta, copy, hard)             # <<<<<<<<<<<<<<
 *     return ppm
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\segmentation\_mrf.pyx":48
 *     ve_step(<ndarray>ppm, <ndarray>ref, <ndarray>XYZ, <ndarray>mix,
 *              beta, copy, hard)
 *     return ppm             # <<<<<<<<<<<<<<
 * 
...
/* "d:\home\Alexis\git\nipy\nipy\neurospin\segmentation\_mrf.pyx":51
 * 
 * 
...
static PyObject *__pyx_pf_4nipy_9neurospin_12segmentation_4_mrf__concensus(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\segmentation\_mrf.pyx":52
 * 
 * def _concensus(ppm, XYZ, mix=None):
 *     return concensus(<ndarray>ppm, <ndarray>XYZ, <ndarray>mix)             # <<<<<<<<<<<<<<
 * 
...
#endif
{
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\segmentation\_mrf.pyx":9
 * """
 * 
 * __version__ = '0.2'             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\segmentation\_mrf.pyx":31
 * 
 * # Initialize numpy
 * mrf_import_array()             # <<<<<<<<<<<<<<
 * import_array()
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\segmentation\_mrf.pyx":32
 * # Initialize numpy
 * mrf_import_array()
 * import_array()             # <<<<<<<<<<<<<<
 * import numpy as np
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\segmentation\_mrf.pyx":33
 * mrf_import_array()
 * import_array()
 * import numpy as np             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\segmentation\_mrf.pyx":1
 * # -*- Mode: Python -*-             # <<<<<<<<<<<<<<
 * 
 * """
 */
