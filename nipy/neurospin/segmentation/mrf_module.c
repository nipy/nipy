...
/* "/Users/mb312/dev_trees/nipy/nipy/neurospin/segmentation/mrf_module.pyx":32
 * 
 * 
...
static PyObject *__pyx_pf_4nipy_9neurospin_12segmentation_10mrf_module__ve_step(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/segmentation/mrf_module.pyx":34
 * def _ve_step(ppm, ref, XYZ, double beta, int copy, int hard):
 * 
 *     if not ppm.flags['C_CONTIGUOUS'] or not ppm.dtype=='double':             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_3) {
    ...
    /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/segmentation/mrf_module.pyx":35
 * 
 *     if not ppm.flags['C_CONTIGUOUS'] or not ppm.dtype=='double':
 *         raise ValueError('ppm array should be double C-contiguous')             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/segmentation/mrf_module.pyx":37
 *         raise ValueError('ppm array should be double C-contiguous')
 * 
 *     if not ref.flags['C_CONTIGUOUS'] or not ref.dtype=='double':             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_3) {
    ...
    /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/segmentation/mrf_module.pyx":38
 * 
 *     if not ref.flags['C_CONTIGUOUS'] or not ref.dtype=='double':
 *         raise ValueError('ref array should be double C-contiguous')             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/segmentation/mrf_module.pyx":40
 *         raise ValueError('ref array should be double C-contiguous')
 * 
 *     XYZ = np.asarray(XYZ, dtype='int')             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/segmentation/mrf_module.pyx":42
 *     XYZ = np.asarray(XYZ, dtype='int')
 * 
 *     ve_step(<ndarray>ppm, <ndarray>ref, <ndarray>XYZ, beta, copy, hard)             # <<<<<<<<<<<<<<
 *     return ppm
 ...
 */
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/segmentation/mrf_module.pyx":43
 * 
 *     ve_step(<ndarray>ppm, <ndarray>ref, <ndarray>XYZ, beta, copy, hard)
 *     return ppm             # <<<<<<<<<<<<<<
 * 
...
/* "/Users/mb312/dev_trees/nipy/nipy/neurospin/segmentation/mrf_module.pyx":46
 * 
 * 
...
static PyObject *__pyx_pf_4nipy_9neurospin_12segmentation_10mrf_module__concensus(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/segmentation/mrf_module.pyx":47
 * 
 * def _concensus(ppm, XYZ):
 *     return concensus(<ndarray>ppm, <ndarray>XYZ)             # <<<<<<<<<<<<<<
 * 
...
#endif
{
  ...
  __pyx_refnanny = __Pyx_RefNanny->SetupContext("PyMODINIT_FUNC PyInit_mrf_module(void)", __LINE__, __FILE__);
  #endif
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("mrf_module"), __pyx_methods, __Pyx_DOCSTR(__pyx_k_9), 0, PYTHON_API_VERSION);
  #else
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/segmentation/mrf_module.pyx":7
 * """
 * 
 * __version__ = '0.0'             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/segmentation/mrf_module.pyx":27
 * 
 * # Initialize numpy
 * mrf_import_array()             # <<<<<<<<<<<<<<
 * import_array()
 ...
 */
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/segmentation/mrf_module.pyx":28
 * # Initialize numpy
 * mrf_import_array()
 * import_array()             # <<<<<<<<<<<<<<
 * import numpy as np
 ...
 */
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/segmentation/mrf_module.pyx":29
 * mrf_import_array()
 * import_array()
 * import numpy as np             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/segmentation/mrf_module.pyx":1
 * # -*- Mode: Python -*-             # <<<<<<<<<<<<<<
 * 
 * """
 */
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_1);
  if (__pyx_m) {
    __Pyx_AddTraceback("init nipy.neurospin.segmentation.mrf_module");
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init nipy.neurospin.segmentation.mrf_module");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
