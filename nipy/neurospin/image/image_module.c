/* Generated by Cython 0.12.1 on Wed May 12 21:17:36 2010 */
...
static PyArrayObject *__pyx_f_4nipy_9neurospin_5image_12image_module__reshaped_double(PyObject *, PyArrayObject *); /*proto*/
...
/* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":33
 * 
 * 
...
static PyObject *__pyx_pf_4nipy_9neurospin_5image_12image_module_cspline_transform(PyObject *__pyx_self, PyObject *__pyx_v_x) {
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":34
 * 
 * def cspline_transform(ndarray x):
 *     c = np.zeros([x.shape[i] for i in range(x.ndim)], dtype=np.double)             # <<<<<<<<<<<<<<
 *     cubic_spline_transform(c, x)
 ...
 */
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":35
 * def cspline_transform(ndarray x):
 *     c = np.zeros([x.shape[i] for i in range(x.ndim)], dtype=np.double)
 *     cubic_spline_transform(c, x)             # <<<<<<<<<<<<<<
 *     return c
 ...
 */
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":36
 *     c = np.zeros([x.shape[i] for i in range(x.ndim)], dtype=np.double)
 *     cubic_spline_transform(c, x)
 *     return c             # <<<<<<<<<<<<<<
 * 
...
/* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":38
 *     return c
 * 
 * cdef ndarray _reshaped_double(object in_arr, ndarray sh_arr):             # <<<<<<<<<<<<<<
...
static  PyArrayObject *__pyx_f_4nipy_9neurospin_5image_12image_module__reshaped_double(PyObject *__pyx_v_in_arr, PyArrayObject *__pyx_v_sh_arr) {
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":39
 * 
 * cdef ndarray _reshaped_double(object in_arr, ndarray sh_arr):
 *     shape = [sh_arr.shape[i] for i in range(sh_arr.ndim)]             # <<<<<<<<<<<<<<
 *     return np.reshape(in_arr, shape).astype(np.double)
 ...
 */
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":40
 * cdef ndarray _reshaped_double(object in_arr, ndarray sh_arr):
 *     shape = [sh_arr.shape[i] for i in range(sh_arr.ndim)]
 *     return np.reshape(in_arr, shape).astype(np.double)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_4);
  __Pyx_AddTraceback("nipy.neurospin.image.image_module._reshaped_double");
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_DECREF(__pyx_v_shape);
  __Pyx_DECREF(__pyx_v_i);
...
/* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":42
 *     return np.reshape(in_arr, shape).astype(np.double)
 * 
 * def cspline_sample1d(ndarray R, ndarray C, X=0):             # <<<<<<<<<<<<<<
 *     cdef double *r, *x
...
static PyObject *__pyx_pf_4nipy_9neurospin_5image_12image_module_cspline_sample1d(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":45
 *     cdef double *r, *x
 *     cdef broadcast multi
 ...
 */
  __pyx_t_1 = ((PyObject *)__pyx_f_4nipy_9neurospin_5image_12image_module__reshaped_double(__pyx_v_X, __pyx_v_R)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 45; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_v_Xa);
  __pyx_v_Xa = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":46
 *     cdef broadcast multi
 *     Xa = _reshaped_double(X, R)
 *     multi = PyArray_MultiIterNew(2, <void*>R, <void*>Xa)             # <<<<<<<<<<<<<<
 *     while(multi.index < multi.size):
 ...
 */
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":47
 *     Xa = _reshaped_double(X, R)
 *     multi = PyArray_MultiIterNew(2, <void*>R, <void*>Xa)
 *     while(multi.index < multi.size):             # <<<<<<<<<<<<<<
 *         r = <double*>PyArray_MultiIter_DATA(multi, 0)
 ...
 */
  while (1) {
    ...
    /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":48
 *     multi = PyArray_MultiIterNew(2, <void*>R, <void*>Xa)
 *     while(multi.index < multi.size):
 *         r = <double*>PyArray_MultiIter_DATA(multi, 0)             # <<<<<<<<<<<<<<
 *         x = <double*>PyArray_MultiIter_DATA(multi, 1)
 ...
 */
    ...
    /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":49
 *     while(multi.index < multi.size):
 *         r = <double*>PyArray_MultiIter_DATA(multi, 0)
 *         x = <double*>PyArray_MultiIter_DATA(multi, 1)             # <<<<<<<<<<<<<<
 *         r[0] = cubic_spline_sample1d(x[0], C)
 ...
 */
    ...
    /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":50
 *         r = <double*>PyArray_MultiIter_DATA(multi, 0)
 *         x = <double*>PyArray_MultiIter_DATA(multi, 1)
 *         r[0] = cubic_spline_sample1d(x[0], C)             # <<<<<<<<<<<<<<
 *         PyArray_MultiIter_NEXT(multi)
 ...
 */
    ...
    /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":51
 *         x = <double*>PyArray_MultiIter_DATA(multi, 1)
 *         r[0] = cubic_spline_sample1d(x[0], C)
 *         PyArray_MultiIter_NEXT(multi)             # <<<<<<<<<<<<<<
 *     return R
 ...
 */
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":52
 *         r[0] = cubic_spline_sample1d(x[0], C)
 *         PyArray_MultiIter_NEXT(multi)
 *     return R             # <<<<<<<<<<<<<<
 * 
...
/* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":54
 *     return R
 * 
 * def cspline_sample2d(ndarray R, ndarray C, X=0, Y=0):             # <<<<<<<<<<<<<<
 *     cdef double *r, *x, *y
...
static PyObject *__pyx_pf_4nipy_9neurospin_5image_12image_module_cspline_sample2d(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":57
 *     cdef double *r, *x, *y
 *     cdef broadcast multi
 *     Xa = _reshaped_double(X, R)             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_1 = ((PyObject *)__pyx_f_4nipy_9neurospin_5image_12image_module__reshaped_double(__pyx_v_X, __pyx_v_R)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 57; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_v_Xa);
  __pyx_v_Xa = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":58
 *     cdef broadcast multi
 *     Xa = _reshaped_double(X, R)
 *     Ya = _reshaped_double(Y, R)             # <<<<<<<<<<<<<<
 *     multi = PyArray_MultiIterNew(3, <void*>R, <void*>Xa, <void*>Ya)
 *     while(multi.index < multi.size):
 */
  __pyx_t_1 = ((PyObject *)__pyx_f_4nipy_9neurospin_5image_12image_module__reshaped_double(__pyx_v_Y, __pyx_v_R)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 58; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_v_Ya);
  __pyx_v_Ya = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":59
 *     Xa = _reshaped_double(X, R)
 *     Ya = _reshaped_double(Y, R)
 *     multi = PyArray_MultiIterNew(3, <void*>R, <void*>Xa, <void*>Ya)             # <<<<<<<<<<<<<<
 *     while(multi.index < multi.size):
 ...
 */
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":60
 *     Ya = _reshaped_double(Y, R)
 *     multi = PyArray_MultiIterNew(3, <void*>R, <void*>Xa, <void*>Ya)
 *     while(multi.index < multi.size):             # <<<<<<<<<<<<<<
 *         r = <double*>PyArray_MultiIter_DATA(multi, 0)
 ...
 */
  while (1) {
    ...
    /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":61
 *     multi = PyArray_MultiIterNew(3, <void*>R, <void*>Xa, <void*>Ya)
 *     while(multi.index < multi.size):
 *         r = <double*>PyArray_MultiIter_DATA(multi, 0)             # <<<<<<<<<<<<<<
 *         x = <double*>PyArray_MultiIter_DATA(multi, 1)
 ...
 */
    ...
    /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":62
 *     while(multi.index < multi.size):
 *         r = <double*>PyArray_MultiIter_DATA(multi, 0)
 *         x = <double*>PyArray_MultiIter_DATA(multi, 1)             # <<<<<<<<<<<<<<
 *         y = <double*>PyArray_MultiIter_DATA(multi, 2)
 ...
 */
    ...
    /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":63
 *         r = <double*>PyArray_MultiIter_DATA(multi, 0)
 *         x = <double*>PyArray_MultiIter_DATA(multi, 1)
 *         y = <double*>PyArray_MultiIter_DATA(multi, 2)             # <<<<<<<<<<<<<<
 *         r[0] = cubic_spline_sample2d(x[0], y[0], C)
 ...
 */
    ...
    /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":64
 *         x = <double*>PyArray_MultiIter_DATA(multi, 1)
 *         y = <double*>PyArray_MultiIter_DATA(multi, 2)
 *         r[0] = cubic_spline_sample2d(x[0], y[0], C)             # <<<<<<<<<<<<<<
 *         PyArray_MultiIter_NEXT(multi)
 ...
 */
    ...
    /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":65
 *         y = <double*>PyArray_MultiIter_DATA(multi, 2)
 *         r[0] = cubic_spline_sample2d(x[0], y[0], C)
 *         PyArray_MultiIter_NEXT(multi)             # <<<<<<<<<<<<<<
 *     return R
 ...
 */
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":66
 *         r[0] = cubic_spline_sample2d(x[0], y[0], C)
 *         PyArray_MultiIter_NEXT(multi)
 *     return R             # <<<<<<<<<<<<<<
 * 
...
/* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":68
 *     return R
 * 
 * def cspline_sample3d(ndarray R, ndarray C, X=0, Y=0, Z=0):             # <<<<<<<<<<<<<<
 *     cdef double *r, *x, *y, *z
...
static PyObject *__pyx_pf_4nipy_9neurospin_5image_12image_module_cspline_sample3d(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":71
 *     cdef double *r, *x, *y, *z
 *     cdef broadcast multi
 *     Xa = _reshaped_double(X, R)             # <<<<<<<<<<<<<<
 *     Ya = _reshaped_double(Y, R)
 ...
 */
  __pyx_t_1 = ((PyObject *)__pyx_f_4nipy_9neurospin_5image_12image_module__reshaped_double(__pyx_v_X, __pyx_v_R)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 71; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_v_Xa);
  __pyx_v_Xa = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":72
 *     cdef broadcast multi
 *     Xa = _reshaped_double(X, R)
 *     Ya = _reshaped_double(Y, R)             # <<<<<<<<<<<<<<
 *     Za = _reshaped_double(Z, R)
 ...
 */
  __pyx_t_1 = ((PyObject *)__pyx_f_4nipy_9neurospin_5image_12image_module__reshaped_double(__pyx_v_Y, __pyx_v_R)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 72; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_v_Ya);
  __pyx_v_Ya = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":73
 *     Xa = _reshaped_double(X, R)
 *     Ya = _reshaped_double(Y, R)
 *     Za = _reshaped_double(Z, R)             # <<<<<<<<<<<<<<
 *     multi = PyArray_MultiIterNew(4, <void*>R, <void*>Xa, <void*>Ya, <void*>Za)
 *     while(multi.index < multi.size):
 */
  __pyx_t_1 = ((PyObject *)__pyx_f_4nipy_9neurospin_5image_12image_module__reshaped_double(__pyx_v_Z, __pyx_v_R)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 73; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_v_Za);
  __pyx_v_Za = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":74
 *     Ya = _reshaped_double(Y, R)
 *     Za = _reshaped_double(Z, R)
 *     multi = PyArray_MultiIterNew(4, <void*>R, <void*>Xa, <void*>Ya, <void*>Za)             # <<<<<<<<<<<<<<
 *     while(multi.index < multi.size):
 ...
 */
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":75
 *     Za = _reshaped_double(Z, R)
 *     multi = PyArray_MultiIterNew(4, <void*>R, <void*>Xa, <void*>Ya, <void*>Za)
 *     while(multi.index < multi.size):             # <<<<<<<<<<<<<<
 *         r = <double*>PyArray_MultiIter_DATA(multi, 0)
 ...
 */
  while (1) {
    ...
    /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":76
 *     multi = PyArray_MultiIterNew(4, <void*>R, <void*>Xa, <void*>Ya, <void*>Za)
 *     while(multi.index < multi.size):
 *         r = <double*>PyArray_MultiIter_DATA(multi, 0)             # <<<<<<<<<<<<<<
 *         x = <double*>PyArray_MultiIter_DATA(multi, 1)
 ...
 */
    ...
    /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":77
 *     while(multi.index < multi.size):
 *         r = <double*>PyArray_MultiIter_DATA(multi, 0)
 *         x = <double*>PyArray_MultiIter_DATA(multi, 1)             # <<<<<<<<<<<<<<
 *         y = <double*>PyArray_MultiIter_DATA(multi, 2)
 ...
 */
    ...
    /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":78
 *         r = <double*>PyArray_MultiIter_DATA(multi, 0)
 *         x = <double*>PyArray_MultiIter_DATA(multi, 1)
 *         y = <double*>PyArray_MultiIter_DATA(multi, 2)             # <<<<<<<<<<<<<<
 *         z = <double*>PyArray_MultiIter_DATA(multi, 3)
 ...
 */
    ...
    /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":79
 *         x = <double*>PyArray_MultiIter_DATA(multi, 1)
 *         y = <double*>PyArray_MultiIter_DATA(multi, 2)
 *         z = <double*>PyArray_MultiIter_DATA(multi, 3)             # <<<<<<<<<<<<<<
 *         r[0] = cubic_spline_sample3d(x[0], y[0], z[0], C)
 ...
 */
    ...
    /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":80
 *         y = <double*>PyArray_MultiIter_DATA(multi, 2)
 *         z = <double*>PyArray_MultiIter_DATA(multi, 3)
 *         r[0] = cubic_spline_sample3d(x[0], y[0], z[0], C)             # <<<<<<<<<<<<<<
 *         PyArray_MultiIter_NEXT(multi)
 ...
 */
    ...
    /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":81
 *         z = <double*>PyArray_MultiIter_DATA(multi, 3)
 *         r[0] = cubic_spline_sample3d(x[0], y[0], z[0], C)
 *         PyArray_MultiIter_NEXT(multi)             # <<<<<<<<<<<<<<
 *     return R
 ...
 */
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":82
 *         r[0] = cubic_spline_sample3d(x[0], y[0], z[0], C)
 *         PyArray_MultiIter_NEXT(multi)
 *     return R             # <<<<<<<<<<<<<<
 * 
...
/* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":85
 * 
 * 
...
static PyObject *__pyx_pf_4nipy_9neurospin_5image_12image_module_cspline_sample4d(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":93
 ...
 *     Za = _reshaped_double(Z, R)
 */
  __pyx_t_1 = ((PyObject *)__pyx_f_4nipy_9neurospin_5image_12image_module__reshaped_double(__pyx_v_X, __pyx_v_R)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 93; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_v_Xa);
  __pyx_v_Xa = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":94
 *     cdef broadcast multi
 *     Xa = _reshaped_double(X, R)
 *     Ya = _reshaped_double(Y, R)             # <<<<<<<<<<<<<<
 *     Za = _reshaped_double(Z, R)
 ...
 */
  __pyx_t_1 = ((PyObject *)__pyx_f_4nipy_9neurospin_5image_12image_module__reshaped_double(__pyx_v_Y, __pyx_v_R)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_v_Ya);
  __pyx_v_Ya = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":95
 *     Xa = _reshaped_double(X, R)
 *     Ya = _reshaped_double(Y, R)
 *     Za = _reshaped_double(Z, R)             # <<<<<<<<<<<<<<
 *     Ta = _reshaped_double(T, R)
 ...
 */
  __pyx_t_1 = ((PyObject *)__pyx_f_4nipy_9neurospin_5image_12image_module__reshaped_double(__pyx_v_Z, __pyx_v_R)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 95; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_v_Za);
  __pyx_v_Za = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":96
 *     Ya = _reshaped_double(Y, R)
 *     Za = _reshaped_double(Z, R)
 *     Ta = _reshaped_double(T, R)             # <<<<<<<<<<<<<<
 *     multi = PyArray_MultiIterNew(5, <void*>R, <void*>Xa, <void*>Ya, <void*>Za, <void*>Ta)
 *     while(multi.index < multi.size):
 */
  __pyx_t_1 = ((PyObject *)__pyx_f_4nipy_9neurospin_5image_12image_module__reshaped_double(__pyx_v_T, __pyx_v_R)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 96; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_v_Ta);
  __pyx_v_Ta = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":97
 *     Za = _reshaped_double(Z, R)
 *     Ta = _reshaped_double(T, R)
 *     multi = PyArray_MultiIterNew(5, <void*>R, <void*>Xa, <void*>Ya, <void*>Za, <void*>Ta)             # <<<<<<<<<<<<<<
 *     while(multi.index < multi.size):
 ...
 */
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":98
 *     Ta = _reshaped_double(T, R)
 *     multi = PyArray_MultiIterNew(5, <void*>R, <void*>Xa, <void*>Ya, <void*>Za, <void*>Ta)
 *     while(multi.index < multi.size):             # <<<<<<<<<<<<<<
 *         r = <double*>PyArray_MultiIter_DATA(multi, 0)
 ...
 */
  while (1) {
    ...
    /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":99
 *     multi = PyArray_MultiIterNew(5, <void*>R, <void*>Xa, <void*>Ya, <void*>Za, <void*>Ta)
 *     while(multi.index < multi.size):
 *         r = <double*>PyArray_MultiIter_DATA(multi, 0)             # <<<<<<<<<<<<<<
 *         x = <double*>PyArray_MultiIter_DATA(multi, 1)
 ...
 */
    ...
    /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":100
 *     while(multi.index < multi.size):
 *         r = <double*>PyArray_MultiIter_DATA(multi, 0)
 *         x = <double*>PyArray_MultiIter_DATA(multi, 1)             # <<<<<<<<<<<<<<
 *         y = <double*>PyArray_MultiIter_DATA(multi, 2)
 ...
 */
    ...
    /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":101
 *         r = <double*>PyArray_MultiIter_DATA(multi, 0)
 *         x = <double*>PyArray_MultiIter_DATA(multi, 1)
 *         y = <double*>PyArray_MultiIter_DATA(multi, 2)             # <<<<<<<<<<<<<<
 *         z = <double*>PyArray_MultiIter_DATA(multi, 3)
 ...
 */
    ...
    /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":102
 *         x = <double*>PyArray_MultiIter_DATA(multi, 1)
 *         y = <double*>PyArray_MultiIter_DATA(multi, 2)
 *         z = <double*>PyArray_MultiIter_DATA(multi, 3)             # <<<<<<<<<<<<<<
 *         t = <double*>PyArray_MultiIter_DATA(multi, 4)
 ...
 */
    ...
    /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":103
 *         y = <double*>PyArray_MultiIter_DATA(multi, 2)
 *         z = <double*>PyArray_MultiIter_DATA(multi, 3)
 *         t = <double*>PyArray_MultiIter_DATA(multi, 4)             # <<<<<<<<<<<<<<
 *         r[0] = cubic_spline_sample4d(x[0], y[0], z[0], t[0], C)
 ...
 */
    ...
    /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":104
 *         z = <double*>PyArray_MultiIter_DATA(multi, 3)
 *         t = <double*>PyArray_MultiIter_DATA(multi, 4)
 *         r[0] = cubic_spline_sample4d(x[0], y[0], z[0], t[0], C)             # <<<<<<<<<<<<<<
 *         PyArray_MultiIter_NEXT(multi)
 ...
 */
    ...
    /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":105
 *         t = <double*>PyArray_MultiIter_DATA(multi, 4)
 *         r[0] = cubic_spline_sample4d(x[0], y[0], z[0], t[0], C)
 *         PyArray_MultiIter_NEXT(multi)             # <<<<<<<<<<<<<<
 *     return R
 ...
 */
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":106
 *         r[0] = cubic_spline_sample4d(x[0], y[0], z[0], t[0], C)
 *         PyArray_MultiIter_NEXT(multi)
 *     return R             # <<<<<<<<<<<<<<
 * 
...
/* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":109
 * 
 * 
...
static PyObject *__pyx_pf_4nipy_9neurospin_5image_12image_module_cspline_resample3d(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":120
 * 
 *     # Create output array
 *     if dtype == None:             # <<<<<<<<<<<<<<
 *         dtype = im.dtype
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":121
 *     # Create output array
 *     if dtype == None:
 *         dtype = im.dtype             # <<<<<<<<<<<<<<
 *     im_resampled = np.zeros(tuple(dims), dtype=dtype)
 ...
 */
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":122
 *     if dtype == None:
 *         dtype = im.dtype
 *     im_resampled = np.zeros(tuple(dims), dtype=dtype)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":126
 *     # Ensure that the Tvox array is C-contiguous (required by the
 ...
 */
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":127
 *     # underlying C routine)
 *     Tvox = np.asarray(Tvox, order='C')
 *     tvox = <double*>Tvox.data             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":130
 * 
 *     # Actual resampling
 ...
 */
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":131
 *     # Actual resampling
 *     cast_integer = np.issubclass(dtype.type, np.integer)
 *     cubic_spline_resample3d(im_resampled, im, tvox, cast_integer)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":133
 *     cubic_spline_resample3d(im_resampled, im, tvox, cast_integer)
 * 
 *     return im_resampled             # <<<<<<<<<<<<<<
 * 
...
#endif
{
  ...
  __pyx_refnanny = __Pyx_RefNanny->SetupContext("PyMODINIT_FUNC PyInit_image_module(void)", __LINE__, __FILE__);
  #endif
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("image_module"), __pyx_methods, __Pyx_DOCSTR(__pyx_k_7), 0, PYTHON_API_VERSION);
  #else
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":8
 * """
 * 
 * __version__ = '0.2'             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":28
 * 
 * # Initialize numpy
 ...
 */
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":29
 * # Initialize numpy
 * cubic_spline_import_array()
 * import_array()             # <<<<<<<<<<<<<<
 * import numpy as np
 ...
 */
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":30
 * cubic_spline_import_array()
 * import_array()
 * import numpy as np             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/image/image_module.pyx":1
 * # -*- Mode: Python -*-             # <<<<<<<<<<<<<<
 * 
 * """
 */
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_3);
  if (__pyx_m) {
    __Pyx_AddTraceback("init nipy.neurospin.image.image_module");
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init nipy.neurospin.image.image_module");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
