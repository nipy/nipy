...
class test_multivariate_stat_saem(unittest.TestCase):
    ...
    def test_model_selection_exact(self):
        ...
        Post1 = P1.compute_log_posterior(nsimu=1e2, burnin=0, verbose=verbose)[0]
        M1 = L1 + Prior1 - Post1
        self.assertAlmostEqual(M1, P1.compute_marginal_likelihood()[0], 1)
        ...
        Post0 = P0.compute_log_posterior(nsimu=1e2, burnin=0, verbose=verbose)[0]
        M0 = L0 + Prior0 - Post0
        self.assertAlmostEqual(M0, P0.compute_marginal_likelihood()[0], 1)
    ...
    def test_model_selection_mfx_spatial_rand_walk(self):
        ...
        P.evaluate(nsimu=100, burnin=10, verbose=verbose, update_spatial=True)
