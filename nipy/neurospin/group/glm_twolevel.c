/* Generated by Cython 0.12.1 on Sat Jul 24 02:22:11 2010 */
...
/* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":46
 * DEF_NITER = 2
 * 
...
static PyObject *__pyx_pf_4nipy_9neurospin_5group_12glm_twolevel_em(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":70
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":73
 * 
 *     # Number of observations / regressors
 *     n = x.size1             # <<<<<<<<<<<<<<
 *     p = x.size2
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":74
 *     # Number of observations / regressors
 *     n = x.size1
 *     p = x.size2             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":77
 * 
 *     # Compute the projected pseudo-inverse matrix
 *     if C == None:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":78
 *     # Compute the projected pseudo-inverse matrix
 *     if C == None:
 *         PpX =  np.linalg.pinv(X)             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":80
 *         PpX =  np.linalg.pinv(X)
 *     else:
 *         A = np.linalg.inv(np.dot(X.transpose(), X)) # (p,p)             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":81
 *     else:
 *         A = np.linalg.inv(np.dot(X.transpose(), X)) # (p,p)
 *         B = np.linalg.inv(np.dot(np.dot(C.transpose(), A), C)) # (q,q)             # <<<<<<<<<<<<<<
 *         P = np.eye(p) - np.dot(np.dot(np.dot(A, C), B), C.transpose()) # (p,p)
 ...
 */
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":82
 *         A = np.linalg.inv(np.dot(X.transpose(), X)) # (p,p)
 *         B = np.linalg.inv(np.dot(np.dot(C.transpose(), A), C)) # (q,q)
 *         P = np.eye(p) - np.dot(np.dot(np.dot(A, C), B), C.transpose()) # (p,p)             # <<<<<<<<<<<<<<
 *         PpX = np.dot(np.dot(P, A), X.transpose()) # (p,n)
 ...
 */
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":83
 *         B = np.linalg.inv(np.dot(np.dot(C.transpose(), A), C)) # (q,q)
 *         P = np.eye(p) - np.dot(np.dot(np.dot(A, C), B), C.transpose()) # (p,p)
 *         PpX = np.dot(np.dot(P, A), X.transpose()) # (p,n)             # <<<<<<<<<<<<<<
 *     ppx = fff_matrix_fromPyArray(PpX)
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":84
 *         P = np.eye(p) - np.dot(np.dot(np.dot(A, C), B), C.transpose()) # (p,p)
 *         PpX = np.dot(np.dot(P, A), X.transpose()) # (p,n)
 *     ppx = fff_matrix_fromPyArray(PpX)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":87
 * 
 *     # Allocate output arrays
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":88
 *     # Allocate output arrays
 *     dims = [Y.shape[i] for i in range(Y.ndim)]
 *     dims[axis] = p             # <<<<<<<<<<<<<<
 *     B = np.zeros(dims)
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":89
 *     dims = [Y.shape[i] for i in range(Y.ndim)]
 *     dims[axis] = p
 *     B = np.zeros(dims)             # <<<<<<<<<<<<<<
 *     dims[axis] = 1
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":90
 *     dims[axis] = p
 *     B = np.zeros(dims)
 *     dims[axis] = 1             # <<<<<<<<<<<<<<
 *     S2 = np.zeros(dims)
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":91
 *     B = np.zeros(dims)
 *     dims[axis] = 1
 *     S2 = np.zeros(dims)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":94
 * 
 *     # Local structs
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":98
 *     # Create a new array iterator
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":101
 * 
 *     # Create views
 *     y = multi.vector[0]             # <<<<<<<<<<<<<<
 *     vy = multi.vector[1]
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":102
 *     # Create views
 *     y = multi.vector[0]
 *     vy = multi.vector[1]             # <<<<<<<<<<<<<<
 *     b = multi.vector[2]
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":103
 *     y = multi.vector[0]
 *     vy = multi.vector[1]
 *     b = multi.vector[2]             # <<<<<<<<<<<<<<
 *     s2 = multi.vector[3]
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":104
 *     vy = multi.vector[1]
 *     b = multi.vector[2]
 *     s2 = multi.vector[3]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":107
 * 
 *         # Loop
 ...
 */
  while (1) {
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":108
 *         # Loop
 *     while(multi.index < multi.size):
 *         fff_glm_twolevel_EM_init(em)             # <<<<<<<<<<<<<<
 *         fff_glm_twolevel_EM_run(em, y, vy, x, ppx, niter)
 ...
 */
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":109
 *     while(multi.index < multi.size):
 *         fff_glm_twolevel_EM_init(em)
 *         fff_glm_twolevel_EM_run(em, y, vy, x, ppx, niter)             # <<<<<<<<<<<<<<
 *         fff_vector_memcpy(b, em.b)
 ...
 */
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":110
 *         fff_glm_twolevel_EM_init(em)
 *         fff_glm_twolevel_EM_run(em, y, vy, x, ppx, niter)
 *         fff_vector_memcpy(b, em.b)             # <<<<<<<<<<<<<<
 *         s2.data[0] = em.s2
 ...
 */
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":111
 *         fff_glm_twolevel_EM_run(em, y, vy, x, ppx, niter)
 *         fff_vector_memcpy(b, em.b)
 *         s2.data[0] = em.s2             # <<<<<<<<<<<<<<
 *         fffpy_multi_iterator_update(multi)
 ...
 */
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":112
 *         fff_vector_memcpy(b, em.b)
 *         s2.data[0] = em.s2
 *         fffpy_multi_iterator_update(multi)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":115
 * 
 *     # Free memory
 *     fff_matrix_delete(x)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":116
 *     # Free memory
 *     fff_matrix_delete(x)
 *     fff_matrix_delete(ppx)             # <<<<<<<<<<<<<<
 *     fffpy_multi_iterator_delete(multi)
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":117
 *     fff_matrix_delete(x)
 *     fff_matrix_delete(ppx)
 *     fffpy_multi_iterator_delete(multi)             # <<<<<<<<<<<<<<
 *     fff_glm_twolevel_EM_delete(em)
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":118
 *     fff_matrix_delete(ppx)
 *     fffpy_multi_iterator_delete(multi)
 *     fff_glm_twolevel_EM_delete(em)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":121
 * 
 *     # Return
 *     return B, S2             # <<<<<<<<<<<<<<
 * 
...
/* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":126
 * 
 * 
...
static PyObject *__pyx_pf_4nipy_9neurospin_5group_12glm_twolevel_log_likelihood(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":139
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":140
 *     # Allocate output array
 *     dims = [Y.shape[i] for i in range(Y.ndim)]
 *     dims[axis] = 1             # <<<<<<<<<<<<<<
 *     LL = np.zeros(dims)
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":141
 *     dims = [Y.shape[i] for i in range(Y.ndim)]
 *     dims[axis] = 1
 *     LL = np.zeros(dims)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":144
 * 
 *     # View on design matrix
 *     x = fff_matrix_fromPyArray(X)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":147
 * 
 *     # Local structure
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":151
 *     # Multi iterator
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":154
 * 
 *     # View on iterable arrays
 *     y = multi.vector[0]             # <<<<<<<<<<<<<<
 *     vy = multi.vector[1]
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":155
 *     # View on iterable arrays
 *     y = multi.vector[0]
 *     vy = multi.vector[1]             # <<<<<<<<<<<<<<
 *     b = multi.vector[2]
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":156
 *     y = multi.vector[0]
 *     vy = multi.vector[1]
 *     b = multi.vector[2]             # <<<<<<<<<<<<<<
 *     s2 = multi.vector[3]
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":157
 *     vy = multi.vector[1]
 *     b = multi.vector[2]
 *     s2 = multi.vector[3]             # <<<<<<<<<<<<<<
 *     ll = multi.vector[4]
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":158
 *     b = multi.vector[2]
 *     s2 = multi.vector[3]
 *     ll = multi.vector[4]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":161
 * 
 *     # Loop
 *     while(multi.index < multi.size):             # <<<<<<<<<<<<<<
 ...
 */
  while (1) {
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":162
 *     # Loop
 *     while(multi.index < multi.size):
 *         ll.data[0] = fff_glm_twolevel_log_likelihood(y, vy, x, b, s2.data[0], tmp)             # <<<<<<<<<<<<<<
 *         fffpy_multi_iterator_update(multi)
 ...
 */
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":163
 *     while(multi.index < multi.size):
 *         ll.data[0] = fff_glm_twolevel_log_likelihood(y, vy, x, b, s2.data[0], tmp)
 *         fffpy_multi_iterator_update(multi)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":166
 * 
 *     # Free memory
 *     fff_matrix_delete(x)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":167
 *     # Free memory
 *     fff_matrix_delete(x)
 *     fff_vector_delete(tmp)             # <<<<<<<<<<<<<<
 *     fffpy_multi_iterator_delete(multi)
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":168
 *     fff_matrix_delete(x)
 *     fff_vector_delete(tmp)
 *     fffpy_multi_iterator_delete(multi)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":171
 * 
 *     # Return
 *     return LL             # <<<<<<<<<<<<<<
 * 
...
/* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":174
 * 
 * 
...
static PyObject *__pyx_pf_4nipy_9neurospin_5group_12glm_twolevel_log_likelihood_ratio(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":180
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":181
 *     # Constrained log-likelihood
 *     B, S2 = em(Y, VY, X, C, axis, niter)
 *     ll0 = log_likelihood(Y, VY, X, B, S2, axis)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":184
 * 
 *     # Unconstrained log-likelihood
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":185
 *     # Unconstrained log-likelihood
 *     B, S2 = em(Y, VY, X, None, axis, niter)
 *     ll = log_likelihood(Y, VY, X, B, S2, axis)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":188
 * 
 *     # -2 log R = 2*(ll-ll0)
 *     lda = 2*(ll-ll0)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":189
 *     # -2 log R = 2*(ll-ll0)
 *     lda = 2*(ll-ll0)
 *     return np.maximum(lda, 0.0)             # <<<<<<<<<<<<<<
 */
...
#endif
{
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":8
 * """
 * 
 * __version__ = '0.1'             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":39
 * 
 * # Initialize numpy
 * fffpy_import_array()             # <<<<<<<<<<<<<<
 * import_array()
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":40
 * # Initialize numpy
 * fffpy_import_array()
 * import_array()             # <<<<<<<<<<<<<<
 * import numpy as np
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":41
 * fffpy_import_array()
 * import_array()
 * import numpy as np             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\glm_twolevel.pyx":44
 * 
 * # Constants
 * DEF_NITER = 2             # <<<<<<<<<<<<<<
 * 
