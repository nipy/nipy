/* Generated by Cython 0.12.1 on Sat Jul 24 02:22:34 2010 */
...
/* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":60
 * 
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":63
 *   cdef double  n
 *   fff_twosample_permutation(NULL, NULL, n1, n2, &n)
 *   return int(n)             # <<<<<<<<<<<<<<
 * 
...
/* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":66
 * 
 * 
...
static PyObject *__pyx_pf_4nipy_9neurospin_5group_9twosample_stat(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":78
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":83
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":84
 *   # Get number of observations
 *   n1 = <unsigned int>Y1.shape[axis]
 *   n2 = <unsigned int>Y2.shape[axis]             # <<<<<<<<<<<<<<
 *   n = n1 + n2
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":88
 * 
 *   # Read out magic numbers
 *   if Magics == None:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_4) {
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":89
 *   # Read out magic numbers
 *   if Magics == None:
 *     magics = fff_vector_new(1)             # <<<<<<<<<<<<<<
 *     magics.data[0] = 0 ## Just to make sure
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":95
 * 
 *   # Create output array
 *   nsimu = magics.size             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":96
 *   # Create output array
 *   nsimu = magics.size
 *   dims = [Y1.shape[i] for i in range(Y1.ndim)]             # <<<<<<<<<<<<<<
 *   dims[axis] = nsimu
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":101
 * 
 *   # Create local structure
 *   yp = fff_vector_new(n)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":102
 *   # Create local structure
 *   yp = fff_vector_new(n)
 *   idx1 = fff_array_new1d(FFF_UINT, n1)             # <<<<<<<<<<<<<<
 *   idx2 = fff_array_new1d(FFF_UINT, n2)
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":107
 * 
 *   # Multi-iterator
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":110
 * 
 *   # Vector views
 *   y1 = multi.vector[0]             # <<<<<<<<<<<<<<
 *   y2 = multi.vector[1]
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":111
 *   # Vector views
 *   y1 = multi.vector[0]
 *   y2 = multi.vector[1]             # <<<<<<<<<<<<<<
 *   t = multi.vector[2]
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":115
 * 
 *   # Loop
 ...
 */
  ...
  for (__pyx_v_simu = 0; __pyx_v_simu < __pyx_t_9; __pyx_v_simu++) {
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":118
 * 
 *     # Set the magic number
 ...
 */
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":123
 ...
 */
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":126
 * 
 *     # Reset the multi-iterator
 ...
 */
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":129
 * 
 *     # Perform the loop
 *     idx = simu*t.stride             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":130
 *     # Perform the loop
 *     idx = simu*t.stride
 *     while(multi.index < multi.size):             # <<<<<<<<<<<<<<
 *       fff_twosample_apply_permutation(yp, NULL, y1, NULL, y2, NULL, nex,
 ...
 */
    while (1) {
      ...
      /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":133
 *       fff_twosample_apply_permutation(yp, NULL, y1, NULL, y2, NULL, nex,
 *                                       <unsigned int*>idx1.data,
 *                                       <unsigned int*>idx2.data)             # <<<<<<<<<<<<<<
 ...
 */
      ...
      /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":134
 *                                       <unsigned int*>idx1.data,
 *                                       <unsigned int*>idx2.data)
 *       t.data[idx] = fff_twosample_stat_eval(stat, yp)             # <<<<<<<<<<<<<<
 *       fffpy_multi_iterator_update(multi)
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":138
 * 
 *   # Delete local structures
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":139
 *   # Delete local structures
 *   fffpy_multi_iterator_delete(multi)
 *   fff_vector_delete(magics)             # <<<<<<<<<<<<<<
 *   fff_vector_delete(yp)
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":146
 * 
 *   # Return
 *   return T             # <<<<<<<<<<<<<<
 * 
...
/* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":149
 * 
 * 
...
static PyObject *__pyx_pf_4nipy_9neurospin_5group_9twosample_stat_mfx(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":150
 * 
 * def stat_mfx(ndarray Y1, ndarray V1, ndarray Y2, ndarray V2,
 *              id='student_mfx', int axis=0, ndarray Magics=None,             # <<<<<<<<<<<<<<
 *              unsigned int niter=5):
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":163
 *   cdef unsigned long int simu, nsimu, idx
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":168
 * 
 *   # Get number of observations
 *   n1 = <unsigned int>Y1.shape[axis]             # <<<<<<<<<<<<<<
 *   n2 = <unsigned int>Y2.shape[axis]
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":169
 *   # Get number of observations
 *   n1 = <unsigned int>Y1.shape[axis]
 *   n2 = <unsigned int>Y2.shape[axis]             # <<<<<<<<<<<<<<
 *   n = n1 + n2
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":173
 * 
 *   # Read out magic numbers
 *   if Magics == None:             # <<<<<<<<<<<<<<
 *     magics = fff_vector_new(1)
 ...
 */
  ...
  if (__pyx_t_4) {
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":174
 *   # Read out magic numbers
 *   if Magics == None:
 *     magics = fff_vector_new(1)             # <<<<<<<<<<<<<<
 *     magics.data[0] = 0 ## Just to make sure
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":180
 * 
 *   # Create output array
 *   nsimu = magics.size             # <<<<<<<<<<<<<<
 *   dims = [Y1.shape[i] for i in range(Y1.ndim)]
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":181
 *   # Create output array
 *   nsimu = magics.size
 *   dims = [Y1.shape[i] for i in range(Y1.ndim)]             # <<<<<<<<<<<<<<
 *   dims[axis] = nsimu
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":186
 * 
 *   # Create local structure
 *   yp = fff_vector_new(n)             # <<<<<<<<<<<<<<
 *   vp = fff_vector_new(n)
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":187
 *   # Create local structure
 *   yp = fff_vector_new(n)
 *   vp = fff_vector_new(n)             # <<<<<<<<<<<<<<
 *   idx1 = fff_array_new1d(FFF_UINT, n1)
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":197
 *                                    <void*>Y1, <void*>V1,
 *                                    <void*>Y2, <void*>V2,
 *                                    <void*>T)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":200
 * 
 *   # Vector views
 *   y1 = multi.vector[0]             # <<<<<<<<<<<<<<
 *   v1 = multi.vector[1]
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":201
 *   # Vector views
 *   y1 = multi.vector[0]
 *   v1 = multi.vector[1]             # <<<<<<<<<<<<<<
 *   y2 = multi.vector[2]
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":207
 * 
 *   # Loop
 *   for simu from 0 <= simu < nsimu:             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  for (__pyx_v_simu = 0; __pyx_v_simu < __pyx_t_9; __pyx_v_simu++) {
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":210
 * 
 *     # Set the magic number
 *     magic = magics.data[simu*magics.stride]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":215
 *     nex = fff_twosample_permutation(<unsigned int*>idx1.data,
 *                                     <unsigned int*>idx2.data,
 *                                     n1, n2, &magic)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":218
 * 
 *     # Reset the multi-iterator
 *     fffpy_multi_iterator_reset(multi)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":221
 * 
 *     # Perform the loop
 *     idx = simu*t.stride             # <<<<<<<<<<<<<<
 *     while(multi.index < multi.size):
 ...
 */
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":222
 *     # Perform the loop
 *     idx = simu*t.stride
 *     while(multi.index < multi.size):             # <<<<<<<<<<<<<<
 *       fff_twosample_apply_permutation(yp, vp, y1, v1, y2, v2, nex,
 ...
 */
    while (1) {
      ...
      /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":225
 *       fff_twosample_apply_permutation(yp, vp, y1, v1, y2, v2, nex,
 *                                       <unsigned int*>idx1.data,
 *                                       <unsigned int*>idx2.data)             # <<<<<<<<<<<<<<
 ...
 */
      ...
      /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":226
 *                                       <unsigned int*>idx1.data,
 *                                       <unsigned int*>idx2.data)
 *       t.data[idx] = fff_twosample_stat_mfx_eval(stat, yp, vp)             # <<<<<<<<<<<<<<
 *       fffpy_multi_iterator_update(multi)
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":230
 * 
 *   # Delete local structures
 *   fffpy_multi_iterator_delete(multi)             # <<<<<<<<<<<<<<
 *   fff_vector_delete(magics)
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":231
 *   # Delete local structures
 *   fffpy_multi_iterator_delete(multi)
 *   fff_vector_delete(magics)             # <<<<<<<<<<<<<<
 *   fff_vector_delete(yp)
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":239
 * 
 *   # Return
 *   return T             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":49
 * 
 * # Initialize numpy
 * fffpy_import_array()             # <<<<<<<<<<<<<<
 * import_array()
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":50
 * # Initialize numpy
 * fffpy_import_array()
 * import_array()             # <<<<<<<<<<<<<<
 * import numpy as np
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":55
 * 
 * # Stat dictionary
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\group\twosample.pyx":56
 * # Stat dictionary
 * stats = {'student': FFF_TWOSAMPLE_STUDENT,
 *          'wilcoxon': FFF_TWOSAMPLE_WILCOXON,             # <<<<<<<<<<<<<<
 *          'student_mfx': FFF_TWOSAMPLE_STUDENT_MFX}
