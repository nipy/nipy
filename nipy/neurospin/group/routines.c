/* Generated by Cython 0.12.1 on Mon May 17 19:45:48 2010 */
...
#endif
#include <math.h>
#define __PYX_HAVE_API__nipy__neurospin__group__routines
#include "stdlib.h"
#include "stdio.h"
...
/* Module declarations from nipy.neurospin.group.routines */
...
#define __Pyx_MODULE_NAME "nipy.neurospin.group.routines"
int __pyx_module_is_main_nipy__neurospin__group__routines = 0;

/* Implementation of nipy.neurospin.group.routines */
...
static char __pyx_k_9[] = "add_lines (line 16)";
...
/* "/Users/mb312/dev_trees/nipy/nipy/neurospin/group/routines.pyx":16
 * 
...
static PyObject *__pyx_pf_4nipy_9neurospin_5group_8routines_add_lines(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_4nipy_9neurospin_5group_8routines_add_lines[] = "\n    add(A, B, I)\n\n    Add each line of A to a line of B indexed by I, where\n    A and B are two-dimensional arrays and I is a\n    one-dimensional array of indices.\n\n    This is equivalent to: \n\n    for i in xrange(len(I)):\n      B[I[i]] += A[i]\n\n    ";
static PyObject *__pyx_pf_4nipy_9neurospin_5group_8routines_add_lines(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    if (unlikely(kw_args > 0)) {
      if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "add_lines") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    }
    ...
    __pyx_v_I = ((PyArrayObject *)PyTuple_GET_ITEM(__pyx_args, 2));
  }
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("nipy.neurospin.group.routines.add_lines");
  return NULL;
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_I), __pyx_ptype_5numpy_ndarray, 1, "I", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_A, (PyObject*)__pyx_v_A, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_B, (PyObject*)__pyx_v_B, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_I, (PyObject*)__pyx_v_I, &__Pyx_TypeInfo_nn___pyx_t_5numpy_int_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_I = __pyx_bstruct_I.strides[0];
  __pyx_bshape_0_I = __pyx_bstruct_I.shape[0];

  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/group/routines.pyx":33
 *     """
 *     cdef int i, j, index
 ...
 */
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/group/routines.pyx":34
 *     cdef int i, j, index
 *     cdef int i_max = I.shape[0]
 *     cdef int j_max = B.shape[1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/group/routines.pyx":36
 *     cdef int j_max = B.shape[1]
 * 
 *     for i in range(i_max):             # <<<<<<<<<<<<<<
 *         index = I[i]
 ...
 */
  ...
  for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    ...
    /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/group/routines.pyx":37
 * 
 *     for i in range(i_max):
 *         index = I[i]             # <<<<<<<<<<<<<<
 *         for j in range(j_max):
 ...
 */
    __pyx_t_3 = __pyx_v_i;
    if (__pyx_t_3 < 0) __pyx_t_3 += __pyx_bshape_0_I;
    __pyx_v_index = (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_int_t *, __pyx_bstruct_I.buf, __pyx_t_3, __pyx_bstride_0_I));

    /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/group/routines.pyx":38
 *     for i in range(i_max):
 *         index = I[i]
 *         for j in range(j_max):             # <<<<<<<<<<<<<<
 *             B[index, j] = B[index, j] + A[i, j]
 ...
 */
    ...
    for (__pyx_t_5 = 0; __pyx_t_5 < __pyx_t_4; __pyx_t_5+=1) {
      ...
      /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/group/routines.pyx":39
 *         index = I[i]
 *         for j in range(j_max):
 *             B[index, j] = B[index, j] + A[i, j]             # <<<<<<<<<<<<<<
 * 
 */
      ...
      __pyx_t_7 = __pyx_v_j;
      if (__pyx_t_6 < 0) __pyx_t_6 += __pyx_bshape_0_B;
      if (__pyx_t_7 < 0) __pyx_t_7 += __pyx_bshape_1_B;
      __pyx_t_8 = __pyx_v_i;
      __pyx_t_9 = __pyx_v_j;
      if (__pyx_t_8 < 0) __pyx_t_8 += __pyx_bshape_0_A;
      if (__pyx_t_9 < 0) __pyx_t_9 += __pyx_bshape_1_A;
      __pyx_t_10 = __pyx_v_index;
      __pyx_t_11 = __pyx_v_j;
      if (__pyx_t_10 < 0) __pyx_t_10 += __pyx_bshape_0_B;
      if (__pyx_t_11 < 0) __pyx_t_11 += __pyx_bshape_1_B;
      *__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float_t *, __pyx_bstruct_B.buf, __pyx_t_10, __pyx_bstride_0_B, __pyx_t_11, __pyx_bstride_1_B) = ((*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float_t *, __pyx_bstruct_B.buf, __pyx_t_6, __pyx_bstride_0_B, __pyx_t_7, __pyx_bstride_1_B)) + (*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float_t *, __pyx_bstruct_A.buf, __pyx_t_8, __pyx_bstride_0_A, __pyx_t_9, __pyx_bstride_1_A)));
    }
  }
...
static struct PyMethodDef __pyx_methods[] = {
  {__Pyx_NAMESTR("add_lines"), (PyCFunction)__pyx_pf_4nipy_9neurospin_5group_8routines_add_lines, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_4nipy_9neurospin_5group_8routines_add_lines)},
  {0, 0, 0, 0}
};
...
#endif
{
  ...
  if (__pyx_module_is_main_nipy__neurospin__group__routines) {
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/group/routines.pyx":8
 * """
 * 
 * __version__ = '0.1'             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/group/routines.pyx":10
 * __version__ = '0.1'
 * 
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 ...
 */
  ...
  /* "/Users/mb312/dev_trees/nipy/nipy/neurospin/group/routines.pyx":1
 ...
 */
  ...
  __pyx_t_2 = PyObject_GetAttr(__pyx_m, __pyx_n_s__add_lines); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_3);
  if (__pyx_m) {
    __Pyx_AddTraceback("init nipy.neurospin.group.routines");
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init nipy.neurospin.group.routines");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
