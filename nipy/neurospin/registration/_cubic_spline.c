/* Generated by Cython 0.12.1 on Fri Aug 27 13:34:39 2010 */
...
#endif
#include <math.h>
#define __PYX_HAVE_API__nipy__neurospin__registration___cubic_spline
#include "stdlib.h"
#include "stdio.h"
...
/* Module declarations from nipy.neurospin.registration._cubic_spline */

static PyArrayObject *__pyx_f_4nipy_9neurospin_12registration_13_cubic_spline__reshaped_double(PyObject *, PyArrayObject *); /*proto*/
#define __Pyx_MODULE_NAME "nipy.neurospin.registration._cubic_spline"
int __pyx_module_is_main_nipy__neurospin__registration___cubic_spline = 0;

/* Implementation of nipy.neurospin.registration._cubic_spline */
...
/* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":32
 * 
 * 
...
static PyObject *__pyx_pf_4nipy_9neurospin_12registration_13_cubic_spline_cspline_transform(PyObject *__pyx_self, PyObject *__pyx_v_x); /*proto*/
static PyObject *__pyx_pf_4nipy_9neurospin_12registration_13_cubic_spline_cspline_transform(PyObject *__pyx_self, PyObject *__pyx_v_x) {
  PyObject *__pyx_v_c;
  PyObject *__pyx_v_i;
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":33
 * 
 * def cspline_transform(ndarray x):
 *     c = np.zeros([x.shape[i] for i in range(x.ndim)], dtype=np.double)             # <<<<<<<<<<<<<<
 *     cubic_spline_transform(c, x)
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":34
 * def cspline_transform(ndarray x):
 *     c = np.zeros([x.shape[i] for i in range(x.ndim)], dtype=np.double)
 *     cubic_spline_transform(c, x)             # <<<<<<<<<<<<<<
 *     return c
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":35
 *     c = np.zeros([x.shape[i] for i in range(x.ndim)], dtype=np.double)
 *     cubic_spline_transform(c, x)
 *     return c             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("nipy.neurospin.registration._cubic_spline.cspline_transform");
  __pyx_r = NULL;
  __pyx_L0:;
  __Pyx_DECREF(__pyx_v_c);
  __Pyx_DECREF(__pyx_v_i);
...
/* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":37
 *     return c
 * 
 * cdef ndarray _reshaped_double(object in_arr, ndarray sh_arr):             # <<<<<<<<<<<<<<
...
static  PyArrayObject *__pyx_f_4nipy_9neurospin_12registration_13_cubic_spline__reshaped_double(PyObject *__pyx_v_in_arr, PyArrayObject *__pyx_v_sh_arr) {
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":38
 * 
 * cdef ndarray _reshaped_double(object in_arr, ndarray sh_arr):
 *     shape = [sh_arr.shape[i] for i in range(sh_arr.ndim)]             # <<<<<<<<<<<<<<
 *     return np.reshape(in_arr, shape).astype(np.double)
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":39
 * cdef ndarray _reshaped_double(object in_arr, ndarray sh_arr):
 *     shape = [sh_arr.shape[i] for i in range(sh_arr.ndim)]
 *     return np.reshape(in_arr, shape).astype(np.double)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_4);
  __Pyx_AddTraceback("nipy.neurospin.registration._cubic_spline._reshaped_double");
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_DECREF(__pyx_v_shape);
  __Pyx_DECREF(__pyx_v_i);
...
/* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":41
 *     return np.reshape(in_arr, shape).astype(np.double)
 * 
 * def cspline_sample1d(ndarray R, ndarray C, X=0):             # <<<<<<<<<<<<<<
 *     cdef double *r, *x
...
static PyObject *__pyx_pf_4nipy_9neurospin_12registration_13_cubic_spline_cspline_sample1d(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pf_4nipy_9neurospin_12registration_13_cubic_spline_cspline_sample1d(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("nipy.neurospin.registration._cubic_spline.cspline_sample1d");
  return NULL;
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":44
 *     cdef double *r, *x
 *     cdef broadcast multi
 ...
 */
  __pyx_t_1 = ((PyObject *)__pyx_f_4nipy_9neurospin_12registration_13_cubic_spline__reshaped_double(__pyx_v_X, __pyx_v_R)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 44; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_v_Xa);
  __pyx_v_Xa = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":45
 *     cdef broadcast multi
 *     Xa = _reshaped_double(X, R)
 *     multi = PyArray_MultiIterNew(2, <void*>R, <void*>Xa)             # <<<<<<<<<<<<<<
 *     while(multi.index < multi.size):
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":46
 *     Xa = _reshaped_double(X, R)
 *     multi = PyArray_MultiIterNew(2, <void*>R, <void*>Xa)
 *     while(multi.index < multi.size):             # <<<<<<<<<<<<<<
 *         r = <double*>PyArray_MultiIter_DATA(multi, 0)
 ...
 */
  while (1) {
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":47
 *     multi = PyArray_MultiIterNew(2, <void*>R, <void*>Xa)
 *     while(multi.index < multi.size):
 *         r = <double*>PyArray_MultiIter_DATA(multi, 0)             # <<<<<<<<<<<<<<
 *         x = <double*>PyArray_MultiIter_DATA(multi, 1)
 ...
 */
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":48
 *     while(multi.index < multi.size):
 *         r = <double*>PyArray_MultiIter_DATA(multi, 0)
 *         x = <double*>PyArray_MultiIter_DATA(multi, 1)             # <<<<<<<<<<<<<<
 *         r[0] = cubic_spline_sample1d(x[0], C)
 ...
 */
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":49
 *         r = <double*>PyArray_MultiIter_DATA(multi, 0)
 *         x = <double*>PyArray_MultiIter_DATA(multi, 1)
 *         r[0] = cubic_spline_sample1d(x[0], C)             # <<<<<<<<<<<<<<
 *         PyArray_MultiIter_NEXT(multi)
 ...
 */
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":50
 *         x = <double*>PyArray_MultiIter_DATA(multi, 1)
 *         r[0] = cubic_spline_sample1d(x[0], C)
 *         PyArray_MultiIter_NEXT(multi)             # <<<<<<<<<<<<<<
 *     return R
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":51
 *         r[0] = cubic_spline_sample1d(x[0], C)
 *         PyArray_MultiIter_NEXT(multi)
 *     return R             # <<<<<<<<<<<<<<
 * 
...
/* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":53
 *     return R
 * 
 * def cspline_sample2d(ndarray R, ndarray C, X=0, Y=0):             # <<<<<<<<<<<<<<
 *     cdef double *r, *x, *y
...
static PyObject *__pyx_pf_4nipy_9neurospin_12registration_13_cubic_spline_cspline_sample2d(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pf_4nipy_9neurospin_12registration_13_cubic_spline_cspline_sample2d(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_R = 0;
  PyArrayObject *__pyx_v_C = 0;
  PyObject *__pyx_v_X = 0;
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("nipy.neurospin.registration._cubic_spline.cspline_sample2d");
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __Pyx_INCREF((PyObject *)__pyx_v_R);
  __Pyx_INCREF((PyObject *)__pyx_v_C);
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":56
 *     cdef double *r, *x, *y
 *     cdef broadcast multi
 *     Xa = _reshaped_double(X, R)             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_1 = ((PyObject *)__pyx_f_4nipy_9neurospin_12registration_13_cubic_spline__reshaped_double(__pyx_v_X, __pyx_v_R)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 56; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_v_Xa);
  __pyx_v_Xa = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":57
 *     cdef broadcast multi
 *     Xa = _reshaped_double(X, R)
 *     Ya = _reshaped_double(Y, R)             # <<<<<<<<<<<<<<
 *     multi = PyArray_MultiIterNew(3, <void*>R, <void*>Xa, <void*>Ya)
 *     while(multi.index < multi.size):
 */
  __pyx_t_1 = ((PyObject *)__pyx_f_4nipy_9neurospin_12registration_13_cubic_spline__reshaped_double(__pyx_v_Y, __pyx_v_R)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 57; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_v_Ya);
  __pyx_v_Ya = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":58
 *     Xa = _reshaped_double(X, R)
 *     Ya = _reshaped_double(Y, R)
 *     multi = PyArray_MultiIterNew(3, <void*>R, <void*>Xa, <void*>Ya)             # <<<<<<<<<<<<<<
 *     while(multi.index < multi.size):
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":59
 *     Ya = _reshaped_double(Y, R)
 *     multi = PyArray_MultiIterNew(3, <void*>R, <void*>Xa, <void*>Ya)
 *     while(multi.index < multi.size):             # <<<<<<<<<<<<<<
 *         r = <double*>PyArray_MultiIter_DATA(multi, 0)
 ...
 */
  while (1) {
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":60
 *     multi = PyArray_MultiIterNew(3, <void*>R, <void*>Xa, <void*>Ya)
 *     while(multi.index < multi.size):
 *         r = <double*>PyArray_MultiIter_DATA(multi, 0)             # <<<<<<<<<<<<<<
 *         x = <double*>PyArray_MultiIter_DATA(multi, 1)
 ...
 */
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":61
 *     while(multi.index < multi.size):
 *         r = <double*>PyArray_MultiIter_DATA(multi, 0)
 *         x = <double*>PyArray_MultiIter_DATA(multi, 1)             # <<<<<<<<<<<<<<
 *         y = <double*>PyArray_MultiIter_DATA(multi, 2)
 ...
 */
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":62
 *         r = <double*>PyArray_MultiIter_DATA(multi, 0)
 *         x = <double*>PyArray_MultiIter_DATA(multi, 1)
 *         y = <double*>PyArray_MultiIter_DATA(multi, 2)             # <<<<<<<<<<<<<<
 *         r[0] = cubic_spline_sample2d(x[0], y[0], C)
 ...
 */
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":63
 *         x = <double*>PyArray_MultiIter_DATA(multi, 1)
 *         y = <double*>PyArray_MultiIter_DATA(multi, 2)
 *         r[0] = cubic_spline_sample2d(x[0], y[0], C)             # <<<<<<<<<<<<<<
 *         PyArray_MultiIter_NEXT(multi)
 ...
 */
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":64
 *         y = <double*>PyArray_MultiIter_DATA(multi, 2)
 *         r[0] = cubic_spline_sample2d(x[0], y[0], C)
 *         PyArray_MultiIter_NEXT(multi)             # <<<<<<<<<<<<<<
 *     return R
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":65
 *         r[0] = cubic_spline_sample2d(x[0], y[0], C)
 *         PyArray_MultiIter_NEXT(multi)
 *     return R             # <<<<<<<<<<<<<<
 * 
...
/* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":67
 *     return R
 * 
 * def cspline_sample3d(ndarray R, ndarray C, X=0, Y=0, Z=0):             # <<<<<<<<<<<<<<
 *     cdef double *r, *x, *y, *z
...
static PyObject *__pyx_pf_4nipy_9neurospin_12registration_13_cubic_spline_cspline_sample3d(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pf_4nipy_9neurospin_12registration_13_cubic_spline_cspline_sample3d(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_R = 0;
  PyArrayObject *__pyx_v_C = 0;
  PyObject *__pyx_v_X = 0;
  PyObject *__pyx_v_Y = 0;
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("nipy.neurospin.registration._cubic_spline.cspline_sample3d");
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __Pyx_INCREF((PyObject *)__pyx_v_R);
  __Pyx_INCREF((PyObject *)__pyx_v_C);
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":70
 *     cdef double *r, *x, *y, *z
 *     cdef broadcast multi
 *     Xa = _reshaped_double(X, R)             # <<<<<<<<<<<<<<
 *     Ya = _reshaped_double(Y, R)
 ...
 */
  __pyx_t_1 = ((PyObject *)__pyx_f_4nipy_9neurospin_12registration_13_cubic_spline__reshaped_double(__pyx_v_X, __pyx_v_R)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 70; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_v_Xa);
  __pyx_v_Xa = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":71
 *     cdef broadcast multi
 *     Xa = _reshaped_double(X, R)
 *     Ya = _reshaped_double(Y, R)             # <<<<<<<<<<<<<<
 *     Za = _reshaped_double(Z, R)
 ...
 */
  __pyx_t_1 = ((PyObject *)__pyx_f_4nipy_9neurospin_12registration_13_cubic_spline__reshaped_double(__pyx_v_Y, __pyx_v_R)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 71; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_v_Ya);
  __pyx_v_Ya = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":72
 *     Xa = _reshaped_double(X, R)
 *     Ya = _reshaped_double(Y, R)
 *     Za = _reshaped_double(Z, R)             # <<<<<<<<<<<<<<
 *     multi = PyArray_MultiIterNew(4, <void*>R, <void*>Xa, <void*>Ya, <void*>Za)
 *     while(multi.index < multi.size):
 */
  __pyx_t_1 = ((PyObject *)__pyx_f_4nipy_9neurospin_12registration_13_cubic_spline__reshaped_double(__pyx_v_Z, __pyx_v_R)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 72; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_v_Za);
  __pyx_v_Za = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":73
 *     Ya = _reshaped_double(Y, R)
 *     Za = _reshaped_double(Z, R)
 *     multi = PyArray_MultiIterNew(4, <void*>R, <void*>Xa, <void*>Ya, <void*>Za)             # <<<<<<<<<<<<<<
 *     while(multi.index < multi.size):
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":74
 *     Za = _reshaped_double(Z, R)
 *     multi = PyArray_MultiIterNew(4, <void*>R, <void*>Xa, <void*>Ya, <void*>Za)
 *     while(multi.index < multi.size):             # <<<<<<<<<<<<<<
 *         r = <double*>PyArray_MultiIter_DATA(multi, 0)
 ...
 */
  while (1) {
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":75
 *     multi = PyArray_MultiIterNew(4, <void*>R, <void*>Xa, <void*>Ya, <void*>Za)
 *     while(multi.index < multi.size):
 *         r = <double*>PyArray_MultiIter_DATA(multi, 0)             # <<<<<<<<<<<<<<
 *         x = <double*>PyArray_MultiIter_DATA(multi, 1)
 ...
 */
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":76
 *     while(multi.index < multi.size):
 *         r = <double*>PyArray_MultiIter_DATA(multi, 0)
 *         x = <double*>PyArray_MultiIter_DATA(multi, 1)             # <<<<<<<<<<<<<<
 *         y = <double*>PyArray_MultiIter_DATA(multi, 2)
 ...
 */
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":77
 *         r = <double*>PyArray_MultiIter_DATA(multi, 0)
 *         x = <double*>PyArray_MultiIter_DATA(multi, 1)
 *         y = <double*>PyArray_MultiIter_DATA(multi, 2)             # <<<<<<<<<<<<<<
 *         z = <double*>PyArray_MultiIter_DATA(multi, 3)
 ...
 */
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":78
 *         x = <double*>PyArray_MultiIter_DATA(multi, 1)
 *         y = <double*>PyArray_MultiIter_DATA(multi, 2)
 *         z = <double*>PyArray_MultiIter_DATA(multi, 3)             # <<<<<<<<<<<<<<
 *         r[0] = cubic_spline_sample3d(x[0], y[0], z[0], C)
 ...
 */
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":79
 *         y = <double*>PyArray_MultiIter_DATA(multi, 2)
 *         z = <double*>PyArray_MultiIter_DATA(multi, 3)
 *         r[0] = cubic_spline_sample3d(x[0], y[0], z[0], C)             # <<<<<<<<<<<<<<
 *         PyArray_MultiIter_NEXT(multi)
 ...
 */
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":80
 *         z = <double*>PyArray_MultiIter_DATA(multi, 3)
 *         r[0] = cubic_spline_sample3d(x[0], y[0], z[0], C)
 *         PyArray_MultiIter_NEXT(multi)             # <<<<<<<<<<<<<<
 *     return R
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":81
 *         r[0] = cubic_spline_sample3d(x[0], y[0], z[0], C)
 *         PyArray_MultiIter_NEXT(multi)
 *     return R             # <<<<<<<<<<<<<<
 * 
...
/* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":84
 * 
 * 
...
static PyObject *__pyx_pf_4nipy_9neurospin_12registration_13_cubic_spline_cspline_sample4d(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_4nipy_9neurospin_12registration_13_cubic_spline_cspline_sample4d[] = "\n    cubic_spline_sample4d(R, C, X=0, Y=0, Z=0, T=0):\n\n    In-place cubic spline sampling. R.dtype must be 'double'. \n    ";
static PyObject *__pyx_pf_4nipy_9neurospin_12registration_13_cubic_spline_cspline_sample4d(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_R = 0;
  PyArrayObject *__pyx_v_C = 0;
  PyObject *__pyx_v_X = 0;
  PyObject *__pyx_v_Y = 0;
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("nipy.neurospin.registration._cubic_spline.cspline_sample4d");
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __Pyx_INCREF((PyObject *)__pyx_v_R);
  __Pyx_INCREF((PyObject *)__pyx_v_C);
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":92
 ...
 *     Za = _reshaped_double(Z, R)
 */
  __pyx_t_1 = ((PyObject *)__pyx_f_4nipy_9neurospin_12registration_13_cubic_spline__reshaped_double(__pyx_v_X, __pyx_v_R)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 92; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_v_Xa);
  __pyx_v_Xa = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":93
 *     cdef broadcast multi
 *     Xa = _reshaped_double(X, R)
 *     Ya = _reshaped_double(Y, R)             # <<<<<<<<<<<<<<
 *     Za = _reshaped_double(Z, R)
 ...
 */
  __pyx_t_1 = ((PyObject *)__pyx_f_4nipy_9neurospin_12registration_13_cubic_spline__reshaped_double(__pyx_v_Y, __pyx_v_R)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 93; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_v_Ya);
  __pyx_v_Ya = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":94
 *     Xa = _reshaped_double(X, R)
 *     Ya = _reshaped_double(Y, R)
 *     Za = _reshaped_double(Z, R)             # <<<<<<<<<<<<<<
 *     Ta = _reshaped_double(T, R)
 ...
 */
  __pyx_t_1 = ((PyObject *)__pyx_f_4nipy_9neurospin_12registration_13_cubic_spline__reshaped_double(__pyx_v_Z, __pyx_v_R)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 94; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_v_Za);
  __pyx_v_Za = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":95
 *     Ya = _reshaped_double(Y, R)
 *     Za = _reshaped_double(Z, R)
 *     Ta = _reshaped_double(T, R)             # <<<<<<<<<<<<<<
 *     multi = PyArray_MultiIterNew(5, <void*>R, <void*>Xa, <void*>Ya, <void*>Za, <void*>Ta)
 *     while(multi.index < multi.size):
 */
  __pyx_t_1 = ((PyObject *)__pyx_f_4nipy_9neurospin_12registration_13_cubic_spline__reshaped_double(__pyx_v_T, __pyx_v_R)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 95; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_v_Ta);
  __pyx_v_Ta = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":96
 *     Za = _reshaped_double(Z, R)
 *     Ta = _reshaped_double(T, R)
 *     multi = PyArray_MultiIterNew(5, <void*>R, <void*>Xa, <void*>Ya, <void*>Za, <void*>Ta)             # <<<<<<<<<<<<<<
 *     while(multi.index < multi.size):
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":97
 *     Ta = _reshaped_double(T, R)
 *     multi = PyArray_MultiIterNew(5, <void*>R, <void*>Xa, <void*>Ya, <void*>Za, <void*>Ta)
 *     while(multi.index < multi.size):             # <<<<<<<<<<<<<<
 *         r = <double*>PyArray_MultiIter_DATA(multi, 0)
 ...
 */
  while (1) {
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":98
 *     multi = PyArray_MultiIterNew(5, <void*>R, <void*>Xa, <void*>Ya, <void*>Za, <void*>Ta)
 *     while(multi.index < multi.size):
 *         r = <double*>PyArray_MultiIter_DATA(multi, 0)             # <<<<<<<<<<<<<<
 *         x = <double*>PyArray_MultiIter_DATA(multi, 1)
 ...
 */
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":99
 *     while(multi.index < multi.size):
 *         r = <double*>PyArray_MultiIter_DATA(multi, 0)
 *         x = <double*>PyArray_MultiIter_DATA(multi, 1)             # <<<<<<<<<<<<<<
 *         y = <double*>PyArray_MultiIter_DATA(multi, 2)
 ...
 */
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":100
 *         r = <double*>PyArray_MultiIter_DATA(multi, 0)
 *         x = <double*>PyArray_MultiIter_DATA(multi, 1)
 *         y = <double*>PyArray_MultiIter_DATA(multi, 2)             # <<<<<<<<<<<<<<
 *         z = <double*>PyArray_MultiIter_DATA(multi, 3)
 ...
 */
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":101
 *         x = <double*>PyArray_MultiIter_DATA(multi, 1)
 *         y = <double*>PyArray_MultiIter_DATA(multi, 2)
 *         z = <double*>PyArray_MultiIter_DATA(multi, 3)             # <<<<<<<<<<<<<<
 *         t = <double*>PyArray_MultiIter_DATA(multi, 4)
 ...
 */
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":102
 *         y = <double*>PyArray_MultiIter_DATA(multi, 2)
 *         z = <double*>PyArray_MultiIter_DATA(multi, 3)
 *         t = <double*>PyArray_MultiIter_DATA(multi, 4)             # <<<<<<<<<<<<<<
 *         r[0] = cubic_spline_sample4d(x[0], y[0], z[0], t[0], C)
 ...
 */
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":103
 *         z = <double*>PyArray_MultiIter_DATA(multi, 3)
 *         t = <double*>PyArray_MultiIter_DATA(multi, 4)
 *         r[0] = cubic_spline_sample4d(x[0], y[0], z[0], t[0], C)             # <<<<<<<<<<<<<<
 *         PyArray_MultiIter_NEXT(multi)
 ...
 */
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":104
 *         t = <double*>PyArray_MultiIter_DATA(multi, 4)
 *         r[0] = cubic_spline_sample4d(x[0], y[0], z[0], t[0], C)
 *         PyArray_MultiIter_NEXT(multi)             # <<<<<<<<<<<<<<
 *     return R
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":105
 *         r[0] = cubic_spline_sample4d(x[0], y[0], z[0], t[0], C)
 *         PyArray_MultiIter_NEXT(multi)
 *     return R             # <<<<<<<<<<<<<<
 * 
...
/* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":108
 * 
 * 
...
static PyObject *__pyx_pf_4nipy_9neurospin_12registration_13_cubic_spline_cspline_resample3d(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_4nipy_9neurospin_12registration_13_cubic_spline_cspline_resample3d[] = "\n    cspline_resample3d(im, dims, Tvox, dtype=None)\n\n    Note that the input transformation Tvox will be re-ordered in C\n    convention if needed.\n    ";
static PyObject *__pyx_pf_4nipy_9neurospin_12registration_13_cubic_spline_cspline_resample3d(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("nipy.neurospin.registration._cubic_spline.cspline_resample3d");
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":119
 * 
 *     # Create output array
 *     if dtype == None:             # <<<<<<<<<<<<<<
 *         dtype = im.dtype
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":120
 *     # Create output array
 *     if dtype == None:
 *         dtype = im.dtype             # <<<<<<<<<<<<<<
 *     im_resampled = np.zeros(tuple(dims), dtype=dtype)
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":121
 *     if dtype == None:
 *         dtype = im.dtype
 *     im_resampled = np.zeros(tuple(dims), dtype=dtype)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":125
 *     # Ensure that the Tvox array is C-contiguous (required by the
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":126
 *     # underlying C routine)
 *     Tvox = np.asarray(Tvox, order='C')
 *     tvox = <double*>Tvox.data             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":129
 * 
 *     # Actual resampling
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_1 = PyObject_GetAttr(__pyx_t_3, __pyx_n_s__issubclass); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 129; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = PyObject_GetAttr(__pyx_v_dtype, __pyx_n_s__type); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 129; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_4 = PyObject_GetAttr(__pyx_t_5, __pyx_n_s__integer); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 129; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  ...
  __pyx_t_3 = 0;
  __pyx_t_4 = 0;
  __pyx_t_4 = PyObject_Call(__pyx_t_1, __pyx_t_5, NULL); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 129; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_6 = __Pyx_PyInt_AsInt(__pyx_t_4); if (unlikely((__pyx_t_6 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 129; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_v_cast_integer = __pyx_t_6;

  /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":130
 *     # Actual resampling
 *     cast_integer = np.issubclass(dtype.type, np.integer)
 *     cubic_spline_resample3d(im_resampled, im, tvox, cast_integer)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":132
 *     cubic_spline_resample3d(im_resampled, im, tvox, cast_integer)
 * 
 *     return im_resampled             # <<<<<<<<<<<<<<
 * 
...
static struct PyMethodDef __pyx_methods[] = {
  {__Pyx_NAMESTR("cspline_transform"), (PyCFunction)__pyx_pf_4nipy_9neurospin_12registration_13_cubic_spline_cspline_transform, METH_O, __Pyx_DOCSTR(0)},
  {__Pyx_NAMESTR("cspline_sample1d"), (PyCFunction)__pyx_pf_4nipy_9neurospin_12registration_13_cubic_spline_cspline_sample1d, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)},
  {__Pyx_NAMESTR("cspline_sample2d"), (PyCFunction)__pyx_pf_4nipy_9neurospin_12registration_13_cubic_spline_cspline_sample2d, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)},
  {__Pyx_NAMESTR("cspline_sample3d"), (PyCFunction)__pyx_pf_4nipy_9neurospin_12registration_13_cubic_spline_cspline_sample3d, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)},
  {__Pyx_NAMESTR("cspline_sample4d"), (PyCFunction)__pyx_pf_4nipy_9neurospin_12registration_13_cubic_spline_cspline_sample4d, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_4nipy_9neurospin_12registration_13_cubic_spline_cspline_sample4d)},
  {__Pyx_NAMESTR("cspline_resample3d"), (PyCFunction)__pyx_pf_4nipy_9neurospin_12registration_13_cubic_spline_cspline_resample3d, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_4nipy_9neurospin_12registration_13_cubic_spline_cspline_resample3d)},
  {0, 0, 0, 0}
};
...
#endif
{
  ...
  if (__pyx_module_is_main_nipy__neurospin__registration___cubic_spline) {
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":7
 * """
 * 
 * __version__ = '0.2'             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":27
 * 
 * # Initialize numpy
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":28
 * # Initialize numpy
 * cubic_spline_import_array()
 * import_array()             # <<<<<<<<<<<<<<
 * import numpy as np
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":29
 * cubic_spline_import_array()
 * import_array()
 * import numpy as np             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\registration\_cubic_spline.pyx":1
 * # -*- Mode: Python -*-             # <<<<<<<<<<<<<<
 * 
 * """
 */
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_3);
  if (__pyx_m) {
    __Pyx_AddTraceback("init nipy.neurospin.registration._cubic_spline");
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init nipy.neurospin.registration._cubic_spline");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
