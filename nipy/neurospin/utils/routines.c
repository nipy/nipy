/* Generated by Cython 0.12.1 on Sat Jul 24 02:22:49 2010 */
...
/* "d:\home\Alexis\git\nipy\nipy\neurospin\utils\routines.pyx":44
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\utils\routines.pyx":63
 *     # Create vector views on both X and Y
 *     x = multi.vector[0]
 *     y = multi.vector[1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\utils\routines.pyx":72
 *     # Delete local structures
 *     fffpy_multi_iterator_delete(multi)
 *     return Y             # <<<<<<<<<<<<<<
 * 
...
/* "d:\home\Alexis\git\nipy\nipy\neurospin\utils\routines.pyx":77
...
static PyObject *__pyx_pf_4nipy_9neurospin_5utils_8routines_median(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\utils\routines.pyx":82
 *     Equivalent to: quantile(x, ratio=0.5, interp=True, axis=axis).
 *     """
...
static PyObject *__pyx_pf_4nipy_9neurospin_5utils_8routines_mahalanobis(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\utils\routines.pyx":99
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\utils\routines.pyx":105
 *     dim = dims[0]
 *     dims[0] = 1
 *     D2 = np.zeros(dims)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\utils\routines.pyx":117
 *     x_tmp = fff_vector_new(n)
 *     vx_tmp = fff_vector_new(n*n)
 *     Sx_tmp = fff_matrix_new(n, n)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\utils\routines.pyx":130
 *         Sx = fff_matrix_view(vx_tmp.data, n, n, n) # OK because vx_tmp is contiguous
 *         d2.data[0] = fff_mahalanobis(x_tmp, &Sx, Sx_tmp)
 *         fffpy_multi_iterator_update(multi)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\utils\routines.pyx":136
 *     fff_vector_delete(vx_tmp)
 *     fff_matrix_delete(Sx_tmp)
 *     fffpy_multi_iterator_delete(multi)             # <<<<<<<<<<<<<<
 * 
...
static PyObject *__pyx_pf_4nipy_9neurospin_5utils_8routines_svd(PyObject *__pyx_self, PyObject *__pyx_v_X) {
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\utils\routines.pyx":155
 *     Vt (n, n, K)
 *     """
 *     cdef int axis=0             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\utils\routines.pyx":168
 *     if m > n:
 *         dmin = n
 *         dmax = m             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\utils\routines.pyx":171
 *     else:
 *         dmin = m
 *         dmax = n             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\utils\routines.pyx":185
 *     Vt = fff_matrix_new(n, n)
 *     x_flat_tmp = fff_vector_new(m*n)
 *     s_tmp = fff_vector_new(dmin)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\utils\routines.pyx":189
 *     # Allocate output array
 *     endims = list(X.shape[2:])
 *     S = np.zeros([dmin]+endims)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\utils\routines.pyx":192
 * 
 *     # Flatten input array
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\utils\routines.pyx":195
 * 
 *     # Create a new array iterator
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\utils\routines.pyx":199
 *     # Create vector views
 *     x_flat = multi.vector[0]
 *     s = multi.vector[1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\utils\routines.pyx":208
 *         info = fff_lapack_dgesdd(&x, s_tmp, U, Vt, work, iwork, Aux )
 *         fff_vector_memcpy(s, s_tmp)
 *         fffpy_multi_iterator_update(multi)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\utils\routines.pyx":218
 *     fff_matrix_delete(U)
 *     fff_matrix_delete(Vt)
 *     fffpy_multi_iterator_delete(multi)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\utils\routines.pyx":221
 * 
 *     # Return
 *     return S             # <<<<<<<<<<<<<<
 * 
...
/* "d:\home\Alexis\git\nipy\nipy\neurospin\utils\routines.pyx":224
 * 
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\utils\routines.pyx":233
 *     cdef unsigned int i
 *     p = fff_array_new2d(FFF_UINT, n, m)
 *     pi = fff_array_new1d(FFF_UINT, n) ## contiguous, dims=(n,1,1,1)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\utils\routines.pyx":238
 *         fff_permutation(<unsigned int*>pi.data, n, magic+i)
 *         pi_view = fff_array_get_block2d(p, 0, n-1, 1, i, i, 1) ## dims=(n,1,1,1)
 *         fff_array_copy(&pi_view, pi)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\utils\routines.pyx":241
 * 
 *     P = fff_array_toPyArray(p)
 *     return P             # <<<<<<<<<<<<<<
 * 
...
/* "d:\home\Alexis\git\nipy\nipy\neurospin\utils\routines.pyx":244
 * 
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\utils\routines.pyx":253
 *     cdef unsigned int i
 *     p = fff_array_new2d(FFF_UINT, k, m)
 *     pi = fff_array_new1d(FFF_UINT, k) ## contiguous, dims=(n,1,1,1)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "d:\home\Alexis\git\nipy\nipy\neurospin\utils\routines.pyx":258
 *         fff_combination(<unsigned int*>pi.data, k, n, magic+i)
 *         pi_view = fff_array_get_block2d(p, 0, k-1, 1, i, i, 1) ## dims=(k,1,1,1)
 *         fff_array_copy(&pi_view, pi)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\utils\routines.pyx":261
 * 
 *     C = fff_array_toPyArray(p)
 *     return C             # <<<<<<<<<<<<<<
 * 
...
/* "d:\home\Alexis\git\nipy\nipy\neurospin\utils\routines.pyx":264
 * 
 * 
 * def gamln(double x):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\utils\routines.pyx":270
 *     cdef double y
 *     y = fff_gamln(x)
 *     return y             # <<<<<<<<<<<<<<
 * 
...
/* "d:\home\Alexis\git\nipy\nipy\neurospin\utils\routines.pyx":273
 * 
 * 
 * def psi(double x):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\utils\routines.pyx":279
 *     cdef double y
 *     y = fff_psi(x)
 *     return y             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "d:\home\Alexis\git\nipy\nipy\neurospin\utils\routines.pyx":41
 * fffpy_import_array()
 * cnp.import_array()
 * import numpy as np             # <<<<<<<<<<<<<<
 * 
