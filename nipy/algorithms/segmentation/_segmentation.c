/* Generated by Cython 0.12.1 on Wed Apr  6 10:23:50 2011 */
 ...
 */
  ...
  /* "/home/alexis/git/nipy/nipy/algorithms/segmentation/_segmentation.pyx":32
 * import_array()
 * import numpy as np
 * import warnings             # <<<<<<<<<<<<<<
 * 
 * def _ve_step(ppm, ref, XYZ, double beta, int synchronous, int scheme):
 */
  __pyx_t_1 = __Pyx_Import(((PyObject *)__pyx_n_s__warnings), 0); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 32; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s__warnings, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 32; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
