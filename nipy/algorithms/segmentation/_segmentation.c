/* Generated by Cython 0.12.1 on Wed May 18 00:22:44 2011 */
...
static char __pyx_k_1[] = "MRF regularization only implemented in 3D, doing nothing";
static char __pyx_k_2[] = "ppm array should be double C-contiguous";
static char __pyx_k_3[] = "ref array should be double C-contiguous";
static char __pyx_k_4[] = "XYZ array should be int C-contiguous";
...
/* "/home/alexis/git/nipy/nipy/algorithms/segmentation/_segmentation.pyx":34
 * 
 * 
...
static PyObject *__pyx_pf_4nipy_10algorithms_12segmentation_13_segmentation__ve_step(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    switch (PyTuple_GET_SIZE(__pyx_args)) {
      ...
      if (likely(values[1])) kw_args--;
        ...
        __Pyx_RaiseArgtupleInvalid("_ve_step", 1, 6, 6, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
      case  2:
      values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__XYZ);
      if (likely(values[2])) kw_args--;
      else {
        __Pyx_RaiseArgtupleInvalid("_ve_step", 1, 6, 6, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
      case  3:
      values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__beta);
      if (likely(values[3])) kw_args--;
      else {
        __Pyx_RaiseArgtupleInvalid("_ve_step", 1, 6, 6, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
      case  4:
      values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__synchronous);
      if (likely(values[4])) kw_args--;
      else {
        __Pyx_RaiseArgtupleInvalid("_ve_step", 1, 6, 6, 4); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
      case  5:
      values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__scheme);
      if (likely(values[5])) kw_args--;
      else {
        __Pyx_RaiseArgtupleInvalid("_ve_step", 1, 6, 6, 5); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    }
    if (unlikely(kw_args > 0)) {
      if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "_ve_step") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    }
    __pyx_v_ppm = values[0];
    __pyx_v_ref = values[1];
    __pyx_v_XYZ = values[2];
    __pyx_v_beta = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_beta == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_synchronous = __Pyx_PyInt_AsInt(values[4]); if (unlikely((__pyx_v_synchronous == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_scheme = __Pyx_PyInt_AsInt(values[5]); if (unlikely((__pyx_v_scheme == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    ...
    __pyx_v_beta = __pyx_PyFloat_AsDouble(PyTuple_GET_ITEM(__pyx_args, 3)); if (unlikely((__pyx_v_beta == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_synchronous = __Pyx_PyInt_AsInt(PyTuple_GET_ITEM(__pyx_args, 4)); if (unlikely((__pyx_v_synchronous == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_scheme = __Pyx_PyInt_AsInt(PyTuple_GET_ITEM(__pyx_args, 5)); if (unlikely((__pyx_v_scheme == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("_ve_step", 1, 6, 6, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  ...
  /* "/home/alexis/git/nipy/nipy/algorithms/segmentation/_segmentation.pyx":36
 * def _ve_step(ppm, ref, XYZ, double beta, int synchronous, int scheme):
 * 
 *     if not XYZ.shape[1] == 3:             # <<<<<<<<<<<<<<
 ...
 *         return ppm
 */
  __pyx_t_1 = PyObject_GetAttr(__pyx_v_XYZ, __pyx_n_s__shape); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_GetItemInt(__pyx_t_1, 1, sizeof(long), PyInt_FromLong); if (!__pyx_t_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyObject_RichCompare(__pyx_t_2, __pyx_int_3, Py_EQ); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  if (__pyx_t_4) {
    ...
    /* "/home/alexis/git/nipy/nipy/algorithms/segmentation/_segmentation.pyx":37
 * 
 *     if not XYZ.shape[1] == 3:
 *         warnings.warn('MRF regularization only implemented in 3D, doing nothing')             # <<<<<<<<<<<<<<
 *         return ppm
 ...
 */
    __pyx_t_1 = __Pyx_GetName(__pyx_m, __pyx_n_s__warnings); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 37; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_2 = PyObject_GetAttr(__pyx_t_1, __pyx_n_s__warn); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 37; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    ...
    __pyx_t_5 = PyObject_Call(__pyx_t_2, __pyx_t_1, NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 37; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;

    /* "/home/alexis/git/nipy/nipy/algorithms/segmentation/_segmentation.pyx":38
 *     if not XYZ.shape[1] == 3:
 *         warnings.warn('MRF regularization only implemented in 3D, doing nothing')
 *         return ppm             # <<<<<<<<<<<<<<
 *     if not ppm.flags['C_CONTIGUOUS'] or not ppm.dtype=='double':
 ...
 */
  ...
  /* "/home/alexis/git/nipy/nipy/algorithms/segmentation/_segmentation.pyx":39
 *         warnings.warn('MRF regularization only implemented in 3D, doing nothing')
 *         return ppm
 *     if not ppm.flags['C_CONTIGUOUS'] or not ppm.dtype=='double':             # <<<<<<<<<<<<<<
 *         raise ValueError('ppm array should be double C-contiguous')
 ...
 */
  __pyx_t_5 = PyObject_GetAttr(__pyx_v_ppm, __pyx_n_s__flags); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_1 = PyObject_GetItem(__pyx_t_5, ((PyObject *)__pyx_n_s__C_CONTIGUOUS)); if (!__pyx_t_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  ...
  __pyx_t_3 = (!__pyx_t_4);
  if (!__pyx_t_3) {
    __pyx_t_1 = PyObject_GetAttr(__pyx_v_ppm, __pyx_n_s__dtype); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_5 = PyObject_RichCompare(__pyx_t_1, ((PyObject *)__pyx_n_s__double), Py_EQ); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_4 = __Pyx_PyObject_IsTrue(__pyx_t_5); if (unlikely(__pyx_t_4 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_t_6 = (!__pyx_t_4);
    __pyx_t_4 = __pyx_t_6;
  } else {
  ...
  if (__pyx_t_4) {
    ...
    /* "/home/alexis/git/nipy/nipy/algorithms/segmentation/_segmentation.pyx":40
 *         return ppm
 *     if not ppm.flags['C_CONTIGUOUS'] or not ppm.dtype=='double':
 *         raise ValueError('ppm array should be double C-contiguous')             # <<<<<<<<<<<<<<
 *     if not ref.flags['C_CONTIGUOUS'] or not ref.dtype=='double':
 ...
 */
    ...
    __pyx_t_1 = PyObject_Call(__pyx_builtin_ValueError, __pyx_t_5, NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  ...
  /* "/home/alexis/git/nipy/nipy/algorithms/segmentation/_segmentation.pyx":41
 *     if not ppm.flags['C_CONTIGUOUS'] or not ppm.dtype=='double':
 *         raise ValueError('ppm array should be double C-contiguous')
 *     if not ref.flags['C_CONTIGUOUS'] or not ref.dtype=='double':             # <<<<<<<<<<<<<<
 *         raise ValueError('ref array should be double C-contiguous')
 ...
 */
  __pyx_t_1 = PyObject_GetAttr(__pyx_v_ref, __pyx_n_s__flags); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_5 = PyObject_GetItem(__pyx_t_1, ((PyObject *)__pyx_n_s__C_CONTIGUOUS)); if (!__pyx_t_5) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  __pyx_t_3 = (!__pyx_t_4);
  if (!__pyx_t_3) {
    __pyx_t_5 = PyObject_GetAttr(__pyx_v_ref, __pyx_n_s__dtype); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_1 = PyObject_RichCompare(__pyx_t_5, ((PyObject *)__pyx_n_s__double), Py_EQ); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  ...
  if (__pyx_t_4) {
    ...
    /* "/home/alexis/git/nipy/nipy/algorithms/segmentation/_segmentation.pyx":42
 *         raise ValueError('ppm array should be double C-contiguous')
 *     if not ref.flags['C_CONTIGUOUS'] or not ref.dtype=='double':
 *         raise ValueError('ref array should be double C-contiguous')             # <<<<<<<<<<<<<<
 *     if not XYZ.flags['C_CONTIGUOUS'] or not XYZ.dtype=='int':
 ...
 */
    ...
    __pyx_t_5 = PyObject_Call(__pyx_builtin_ValueError, __pyx_t_1, NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 42; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  /* "/home/alexis/git/nipy/nipy/algorithms/segmentation/_segmentation.pyx":43
 *     if not ref.flags['C_CONTIGUOUS'] or not ref.dtype=='double':
 *         raise ValueError('ref array should be double C-contiguous')
 *     if not XYZ.flags['C_CONTIGUOUS'] or not XYZ.dtype=='int':             # <<<<<<<<<<<<<<
 *         raise ValueError('XYZ array should be int C-contiguous')
 * 
 */
  __pyx_t_5 = PyObject_GetAttr(__pyx_v_XYZ, __pyx_n_s__flags); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_1 = PyObject_GetItem(__pyx_t_5, ((PyObject *)__pyx_n_s__C_CONTIGUOUS)); if (!__pyx_t_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  ...
  __pyx_t_3 = (!__pyx_t_4);
  if (!__pyx_t_3) {
    __pyx_t_1 = PyObject_GetAttr(__pyx_v_XYZ, __pyx_n_s__dtype); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_5 = PyObject_RichCompare(__pyx_t_1, ((PyObject *)__pyx_n_s__int), Py_EQ); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  if (__pyx_t_4) {
    ...
    /* "/home/alexis/git/nipy/nipy/algorithms/segmentation/_segmentation.pyx":44
 *         raise ValueError('ref array should be double C-contiguous')
 *     if not XYZ.flags['C_CONTIGUOUS'] or not XYZ.dtype=='int':
 *         raise ValueError('XYZ array should be int C-contiguous')             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_t_1 = PyObject_Call(__pyx_builtin_ValueError, __pyx_t_5, NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 44; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __Pyx_Raise(__pyx_t_1, 0, 0);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  /* "/home/alexis/git/nipy/nipy/algorithms/segmentation/_segmentation.pyx":46
 *         raise ValueError('XYZ array should be int C-contiguous')
 * 
 *     ve_step(<ndarray>ppm, <ndarray>ref, <ndarray>XYZ, beta, synchronous, scheme)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/alexis/git/nipy/nipy/algorithms/segmentation/_segmentation.pyx":48
 *     ve_step(<ndarray>ppm, <ndarray>ref, <ndarray>XYZ, beta, synchronous, scheme)
 * 
 *     return ppm             # <<<<<<<<<<<<<<
 * 
...
/* "/home/alexis/git/nipy/nipy/algorithms/segmentation/_segmentation.pyx":51
 * 
 * 
...
static PyObject *__pyx_pf_4nipy_10algorithms_12segmentation_13_segmentation__interaction_energy(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pf_4nipy_10algorithms_12segmentation_13_segmentation__interaction_energy(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyObject *__pyx_v_ppm = 0;
  PyObject *__pyx_v_XYZ = 0;
  PyObject *__pyx_r = NULL;
  PyObject *__pyx_t_1 = NULL;
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    switch (PyTuple_GET_SIZE(__pyx_args)) {
      ...
      if (likely(values[1])) kw_args--;
        ...
        __Pyx_RaiseArgtupleInvalid("_interaction_energy", 1, 2, 2, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    }
    if (unlikely(kw_args > 0)) {
      if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "_interaction_energy") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    }
    __pyx_v_ppm = values[0];
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("_interaction_energy", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  ...
  /* "/home/alexis/git/nipy/nipy/algorithms/segmentation/_segmentation.pyx":53
 * def _interaction_energy(ppm, XYZ):
 * 
 *     if not XYZ.shape[1] == 3:             # <<<<<<<<<<<<<<
 *         warnings.warn('MRF regularization only implemented in 3D, doing nothing')
 *         return ppm
 */
  __pyx_t_1 = PyObject_GetAttr(__pyx_v_XYZ, __pyx_n_s__shape); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 53; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_GetItemInt(__pyx_t_1, 1, sizeof(long), PyInt_FromLong); if (!__pyx_t_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 53; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  if (__pyx_t_4) {
    ...
    /* "/home/alexis/git/nipy/nipy/algorithms/segmentation/_segmentation.pyx":54
 * 
 *     if not XYZ.shape[1] == 3:
 *         warnings.warn('MRF regularization only implemented in 3D, doing nothing')             # <<<<<<<<<<<<<<
 *         return ppm
 *     if not ppm.flags['C_CONTIGUOUS'] or not ppm.dtype=='double':
 */
    __pyx_t_1 = __Pyx_GetName(__pyx_m, __pyx_n_s__warnings); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 54; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_2 = PyObject_GetAttr(__pyx_t_1, __pyx_n_s__warn); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 54; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    ...
    PyTuple_SET_ITEM(__pyx_t_1, 0, ((PyObject *)__pyx_kp_s_1));
    __Pyx_GIVEREF(((PyObject *)__pyx_kp_s_1));
    __pyx_t_5 = PyObject_Call(__pyx_t_2, __pyx_t_1, NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 54; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;

    /* "/home/alexis/git/nipy/nipy/algorithms/segmentation/_segmentation.pyx":55
 *     if not XYZ.shape[1] == 3:
 *         warnings.warn('MRF regularization only implemented in 3D, doing nothing')
 *         return ppm             # <<<<<<<<<<<<<<
 *     if not ppm.flags['C_CONTIGUOUS'] or not ppm.dtype=='double':
 ...
 */
  ...
  /* "/home/alexis/git/nipy/nipy/algorithms/segmentation/_segmentation.pyx":56
 *         warnings.warn('MRF regularization only implemented in 3D, doing nothing')
 *         return ppm
 *     if not ppm.flags['C_CONTIGUOUS'] or not ppm.dtype=='double':             # <<<<<<<<<<<<<<
 *         raise ValueError('ppm array should be double C-contiguous')
 *     if not XYZ.flags['C_CONTIGUOUS'] or not XYZ.dtype=='int':
 */
  __pyx_t_5 = PyObject_GetAttr(__pyx_v_ppm, __pyx_n_s__flags); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 56; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_1 = PyObject_GetItem(__pyx_t_5, ((PyObject *)__pyx_n_s__C_CONTIGUOUS)); if (!__pyx_t_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 56; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  ...
  __pyx_t_3 = (!__pyx_t_4);
  if (!__pyx_t_3) {
    __pyx_t_1 = PyObject_GetAttr(__pyx_v_ppm, __pyx_n_s__dtype); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 56; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_5 = PyObject_RichCompare(__pyx_t_1, ((PyObject *)__pyx_n_s__double), Py_EQ); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 56; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_4 = __Pyx_PyObject_IsTrue(__pyx_t_5); if (unlikely(__pyx_t_4 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 56; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_t_6 = (!__pyx_t_4);
    __pyx_t_4 = __pyx_t_6;
  } else {
  ...
  if (__pyx_t_4) {
    ...
    /* "/home/alexis/git/nipy/nipy/algorithms/segmentation/_segmentation.pyx":57
 *         return ppm
 *     if not ppm.flags['C_CONTIGUOUS'] or not ppm.dtype=='double':
 *         raise ValueError('ppm array should be double C-contiguous')             # <<<<<<<<<<<<<<
 *     if not XYZ.flags['C_CONTIGUOUS'] or not XYZ.dtype=='int':
 ...
 */
    ...
    PyTuple_SET_ITEM(__pyx_t_5, 0, ((PyObject *)__pyx_kp_s_2));
    __Pyx_GIVEREF(((PyObject *)__pyx_kp_s_2));
    __pyx_t_1 = PyObject_Call(__pyx_builtin_ValueError, __pyx_t_5, NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 57; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __Pyx_Raise(__pyx_t_1, 0, 0);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  /* "/home/alexis/git/nipy/nipy/algorithms/segmentation/_segmentation.pyx":58
 *     if not ppm.flags['C_CONTIGUOUS'] or not ppm.dtype=='double':
 *         raise ValueError('ppm array should be double C-contiguous')
 *     if not XYZ.flags['C_CONTIGUOUS'] or not XYZ.dtype=='int':             # <<<<<<<<<<<<<<
 *         raise ValueError('XYZ array should be int C-contiguous')
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_5 = PyObject_GetItem(__pyx_t_1, ((PyObject *)__pyx_n_s__C_CONTIGUOUS)); if (!__pyx_t_5) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 58; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  __pyx_t_3 = (!__pyx_t_4);
  if (!__pyx_t_3) {
    __pyx_t_5 = PyObject_GetAttr(__pyx_v_XYZ, __pyx_n_s__dtype); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 58; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_1 = PyObject_RichCompare(__pyx_t_5, ((PyObject *)__pyx_n_s__int), Py_EQ); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 58; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  ...
  if (__pyx_t_4) {
    ...
    /* "/home/alexis/git/nipy/nipy/algorithms/segmentation/_segmentation.pyx":59
 *         raise ValueError('ppm array should be double C-contiguous')
 *     if not XYZ.flags['C_CONTIGUOUS'] or not XYZ.dtype=='int':
 *         raise ValueError('XYZ array should be int C-contiguous')             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __Pyx_GIVEREF(((PyObject *)__pyx_kp_s_4));
    __pyx_t_5 = PyObject_Call(__pyx_builtin_ValueError, __pyx_t_1, NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 59; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __Pyx_Raise(__pyx_t_5, 0, 0);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  ...
  /* "/home/alexis/git/nipy/nipy/algorithms/segmentation/_segmentation.pyx":61
 *         raise ValueError('XYZ array should be int C-contiguous')
 * 
 *     return interaction_energy(<ndarray>ppm, <ndarray>XYZ)             # <<<<<<<<<<<<<<
 * 
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_5 = PyFloat_FromDouble(interaction_energy(((PyArrayObject *)__pyx_v_ppm), ((PyArrayObject *)__pyx_v_XYZ))); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_r = __pyx_t_5;
  __pyx_t_5 = 0;
  goto __pyx_L0;
...
static struct PyMethodDef __pyx_methods[] = {
  {__Pyx_NAMESTR("_ve_step"), (PyCFunction)__pyx_pf_4nipy_10algorithms_12segmentation_13_segmentation__ve_step, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)},
  {__Pyx_NAMESTR("_interaction_energy"), (PyCFunction)__pyx_pf_4nipy_10algorithms_12segmentation_13_segmentation__interaction_energy, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)},
  {0, 0, 0, 0}
};
...
#endif
{
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("_segmentation"), __pyx_methods, __Pyx_DOCSTR(__pyx_k_11), 0, PYTHON_API_VERSION);
  #else
  ...
  /* "/home/alexis/git/nipy/nipy/algorithms/segmentation/_segmentation.pyx":9
 * """
 * 
 * __version__ = '0.2'             # <<<<<<<<<<<<<<
 * 
 * # Includes
 */
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s____version__, ((PyObject *)__pyx_kp_s_12)) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

  /* "/home/alexis/git/nipy/nipy/algorithms/segmentation/_segmentation.pyx":28
 * 
 * # Initialize numpy
 * mrf_import_array()             # <<<<<<<<<<<<<<
 * import_array()
 ...
 */
  ...
  /* "/home/alexis/git/nipy/nipy/algorithms/segmentation/_segmentation.pyx":29
 * # Initialize numpy
 * mrf_import_array()
 * import_array()             # <<<<<<<<<<<<<<
 * import numpy as np
 ...
 */
  ...
  /* "/home/alexis/git/nipy/nipy/algorithms/segmentation/_segmentation.pyx":30
 * mrf_import_array()
 * import_array()
 * import numpy as np             # <<<<<<<<<<<<<<
 * import warnings
 ...
 */
  ...
  /* "/home/alexis/git/nipy/nipy/algorithms/segmentation/_segmentation.pyx":31
 * import_array()
 * import numpy as np
 * import warnings             # <<<<<<<<<<<<<<
 * 
 * 
 */
  __pyx_t_1 = __Pyx_Import(((PyObject *)__pyx_n_s__warnings), 0); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s__warnings, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "/home/alexis/git/nipy/nipy/algorithms/segmentation/_segmentation.pyx":1
 * # -*- Mode: Python -*-             # <<<<<<<<<<<<<<
 * 
 * """
 */
