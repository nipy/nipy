...
from ..graph import wgraph_from_coo_matrix
...
def _compute_individual_regions(domain, stats, threshold=3.0, smin=5,
    ...
    Returns
    -------
    hrois: list of nipy.algorithms.spatial_models.hroi.HierrachicalROI instances
...
def _bsa_dpmm(hrois, prior_h0, subjects, coords, sigma, prevalence_pval,
    ...
    Parameters
    ----------
    hrois: list of nipy.algorithms.spatial_models.hroi.HierarchicalROI instances
...
def compute_landmarks(
    ...
    hrois: list of  nipy.algorithms.spatial_models.hroi.Nroi instances
           representing individual ROIs
    """
