/* Generated by Cython 0.15.1 on Sat Oct 13 02:13:56 2012 */
...
static char __pyx_k_15[] = "nipy.algorithms.statistics._quantile";
...
static PyObject *__pyx_pf_4nipy_10algorithms_10statistics_9_quantile__quantile(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_4nipy_10algorithms_10statistics_9_quantile__quantile[] = "\n    q = quantile(data, ratio, interp=False, axis=0).\n\n    Partial sorting algorithm, very fast!!!\n    ";
static PyMethodDef __pyx_mdef_4nipy_10algorithms_10statistics_9_quantile__quantile = {__Pyx_NAMESTR("_quantile"), (PyCFunction)__pyx_pf_4nipy_10algorithms_10statistics_9_quantile__quantile, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_4nipy_10algorithms_10statistics_9_quantile__quantile)};
static PyObject *__pyx_pf_4nipy_10algorithms_10statistics_9_quantile__quantile(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("_quantile");
  __pyx_self = __pyx_self;
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "_quantile") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 24; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    } else {
      switch (PyTuple_GET_SIZE(__pyx_args)) {
        case  4: values[3] = PyTuple_GET_ITEM(__pyx_args, 3);
  ...
  /* "nipy/algorithms/statistics/_quantile.pyx":35
 * 
 ...
 */
  ...
  /* "nipy/algorithms/statistics/_quantile.pyx":36
 *     # Allocate output array Y
 *     dims = list(X.shape)
 *     dims[axis] = 1             # <<<<<<<<<<<<<<
 *     Y = np.zeros(dims)
 * 
 */
  if (__Pyx_SetItemInt(((PyObject *)__pyx_v_dims), __pyx_v_axis, __pyx_int_1, sizeof(int), PyInt_FromLong) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

  /* "nipy/algorithms/statistics/_quantile.pyx":37
 *     dims = list(X.shape)
 *     dims[axis] = 1
 *     Y = np.zeros(dims)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "nipy/algorithms/statistics/_quantile.pyx":40
 * 
 *     # Set size and stride along specified axis
 *     size = X.shape[axis]             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_t_3 = PyObject_GetAttr(__pyx_v_X, __pyx_n_s__shape); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_1 = __Pyx_GetItemInt(__pyx_t_3, __pyx_v_axis, sizeof(int), PyInt_FromLong); if (!__pyx_t_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_4 = __Pyx_PyInt_AsLong(__pyx_t_1); if (unlikely((__pyx_t_4 == (long)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_size = __pyx_t_4;

  /* "nipy/algorithms/statistics/_quantile.pyx":41
 *     # Set size and stride along specified axis
 *     size = X.shape[axis]
 *     stride = X.strides[axis] / sizeof(double)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_1 = PyObject_GetAttr(__pyx_v_X, __pyx_n_s__strides); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_GetItemInt(__pyx_t_1, __pyx_v_axis, sizeof(int), PyInt_FromLong); if (!__pyx_t_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyInt_FromSize_t((sizeof(double))); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyNumber_Divide(__pyx_t_3, __pyx_t_1); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_4 = __Pyx_PyInt_AsLong(__pyx_t_2); if (unlikely((__pyx_t_4 == (long)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_v_stride = __pyx_t_4;

  /* "nipy/algorithms/statistics/_quantile.pyx":44
 * 
 *     # Create array iterators
 ...
 * 
 */
  __pyx_t_2 = PyArray_IterAllButAxis(__pyx_v_X, (&__pyx_v_axis)); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 44; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (!(likely(((__pyx_t_2) == Py_None) || likely(__Pyx_TypeTest(__pyx_t_2, __pyx_ptype_5numpy_flatiter))))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 44; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_itX = ((PyArrayIterObject *)__pyx_t_2);
  __pyx_t_2 = 0;

  /* "nipy/algorithms/statistics/_quantile.pyx":45
 *     # Create array iterators
 *     itX = np.PyArray_IterAllButAxis(X, &axis)
 *     itY = np.PyArray_IterAllButAxis(Y, &axis)             # <<<<<<<<<<<<<<
 * 
 *     # Loop
 */
  __pyx_t_2 = PyArray_IterAllButAxis(__pyx_v_Y, (&__pyx_v_axis)); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 45; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (!(likely(((__pyx_t_2) == Py_None) || likely(__Pyx_TypeTest(__pyx_t_2, __pyx_ptype_5numpy_flatiter))))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 45; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_itY = ((PyArrayIterObject *)__pyx_t_2);
  __pyx_t_2 = 0;

  /* "nipy/algorithms/statistics/_quantile.pyx":48
 * 
 *     # Loop
 ...
 */
  while (1) {
    __pyx_t_5 = PyArray_ITER_NOTDONE(__pyx_v_itX);
    if (!__pyx_t_5) break;

    /* "nipy/algorithms/statistics/_quantile.pyx":49
 *     # Loop
 *     while np.PyArray_ITER_NOTDONE(itX):
 *         x = <double*>np.PyArray_ITER_DATA(itX)             # <<<<<<<<<<<<<<
 *         y = <double*>np.PyArray_ITER_DATA(itY)
 ...
 */
    ...
    /* "nipy/algorithms/statistics/_quantile.pyx":50
 *     while np.PyArray_ITER_NOTDONE(itX):
 *         x = <double*>np.PyArray_ITER_DATA(itX)
 *         y = <double*>np.PyArray_ITER_DATA(itY)             # <<<<<<<<<<<<<<
 *         y[0] = quantile(x, size, stride, ratio, interp)
 ...
 */
    ...
    /* "nipy/algorithms/statistics/_quantile.pyx":51
 *         x = <double*>np.PyArray_ITER_DATA(itX)
 *         y = <double*>np.PyArray_ITER_DATA(itY)
 *         y[0] = quantile(x, size, stride, ratio, interp)             # <<<<<<<<<<<<<<
 *         np.PyArray_ITER_NEXT(itX)
 ...
 */
    ...
    /* "nipy/algorithms/statistics/_quantile.pyx":52
 *         y = <double*>np.PyArray_ITER_DATA(itY)
 *         y[0] = quantile(x, size, stride, ratio, interp)
 *         np.PyArray_ITER_NEXT(itX)             # <<<<<<<<<<<<<<
 *         np.PyArray_ITER_NEXT(itY)
 ...
 */
    ...
    /* "nipy/algorithms/statistics/_quantile.pyx":53
 *         y[0] = quantile(x, size, stride, ratio, interp)
 *         np.PyArray_ITER_NEXT(itX)
 *         np.PyArray_ITER_NEXT(itY)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "nipy/algorithms/statistics/_quantile.pyx":55
 *         np.PyArray_ITER_NEXT(itY)
 * 
 *     return Y             # <<<<<<<<<<<<<<
 * 
...
static PyObject *__pyx_pf_4nipy_10algorithms_10statistics_9_quantile_1_median(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
...
static PyObject *__pyx_pf_4nipy_10algorithms_10statistics_9_quantile_1_median(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyObject *__pyx_v_X = 0;
  ...
  __Pyx_RefNannySetupContext("_median");
  __pyx_self = __pyx_self;
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "_median") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 60; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    } else {
      switch (PyTuple_GET_SIZE(__pyx_args)) {
        case  2: values[1] = PyTuple_GET_ITEM(__pyx_args, 1);
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("_median", 0, 1, 2, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 60; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_GetName(__pyx_m, __pyx_n_s___quantile); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 64; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  if (PyDict_SetItem(__pyx_t_3, ((PyObject *)__pyx_n_s__axis), __pyx_v_axis) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 64; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_4 = PyFloat_FromDouble(0.5); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 64; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  if (PyDict_SetItem(__pyx_t_3, ((PyObject *)__pyx_n_s__ratio), __pyx_t_4) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 64; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __Pyx_GOTREF(__pyx_t_4);
  if (PyDict_SetItem(__pyx_t_3, ((PyObject *)__pyx_n_s__interp), __pyx_t_4) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 64; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = PyEval_CallObjectWithKeywords(__pyx_t_1, ((PyObject *)__pyx_t_2), ((PyObject *)__pyx_t_3)); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 64; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_t_2)); __pyx_t_2 = 0;
...
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit__quantile(void)");
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("_quantile"), __pyx_methods, __Pyx_DOCSTR(__pyx_k_13), 0, PYTHON_API_VERSION);
  #else
 ...
 */
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s____version__, ((PyObject *)__pyx_kp_s_14)) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 8; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

  /* "nipy/algorithms/statistics/_quantile.pyx":17
 *                     int interp)
 * 
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 ...
 *     q = quantile(data, ratio, interp=False, axis=0).
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4nipy_10algorithms_10statistics_9_quantile__quantile, NULL, __pyx_n_s_15); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 24; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
 ...
 *     median(X, axis=0)
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4nipy_10algorithms_10statistics_9_quantile_1_median, NULL, __pyx_n_s_15); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 60; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s___median, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 60; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
