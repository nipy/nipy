...
quatern2mat(b=0., c=0., d=0., qx=0., qy=0., qz=0., dx=1., dy=1., dz=1., qfac=1.)
returns a 4D transformation matrix

mat2quatern(T) goes in the opposite direction, filling in b,c,d...
...
def setup_quaternion_extension():
    """
...
########## Put in the NIFTI-1 C-header as Doc #################################
...
/*! INTRODUCTION TO NIFTI-1:
   ...
   format are:
    (a) To add information to the header that will be useful for functional
        neuroimaging.data_io.api analysis and display.  These additions include:
