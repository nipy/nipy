...
image_trait = Instance( 'neuroimaging.utils.enthought.pyface.image_resource.ImageResource',
...
a_button = Trait( '', Str, Instance( 'neuroimaging.utils.enthought.traits.ui.menu.Action' ) )
...
AView = Any
#AView = Trait( '', Str, Instance( 'neuroimaging.utils.enthought.traits.ui.View' ) )
