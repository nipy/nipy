...
#  Date: 01/05/2006
#
#  Description: Define the wxPython implementation of the tree-based Python
#               value editor and the value editor factory.
# 
...
class SingleValueTreeNodeObject ( TreeNodeObject ):
    ...
    # User override of default label:
    label = Str
    ...
    def node_for ( self, name, value ): 
        ...
        return node( name = name, value = value, readonly = self.readonly )
