...
#  Description:   Defines the HasTraits class along with several useful
#                 subclasses and the associated meta-classes.
#
...
class HasTraits ( CHasTraits ):
    """ This class enables any Python class derived from it to have attributes
    defined using traits.
    ...
    on trait attributes defined by way of wildcards or by calling `add_trait()`.
    For example::
    ...
    **name** attributes defined on the **Person** class. (The **trait_added**
    ...
    def add_class_trait ( cls, name, *trait ):
        """ Adds the trait specified by *trait* as a new trait called *name*.

        The *trait* parameter can be either a trait or a value that can be
        converted to a trait using the `Trait()` function; it can also be a list
        of traits or values. If more than one value is specified, it is
        equivalent to passing the entire list of values to the `Trait()`
        function.
    ...
    def trait_subclasses ( cls, all = False ):
        ...
        ----------
        all : boolean
            Flag indicating whether to return all subclasses of this class. If
    ...
    def __getstate__ (self):
        ...
        Subclases should override __getstate__ and use the follow pattern 
    ...
    def get ( self, *names ):
        """ Shortcut for getting object traits.

        Parameters
        ----------
        names : list of trait names whose values are to be returned
    ...
    def set ( self, trait_change_notify = True, **traits ):
        ...
        traits : list of key/value pairs
            List of trait attributes and their values to be set
    ...
    def reset_traits ( self, traits = None ):
        ...
        traits : list of strings
            List of trait attributes to reset
    ...
    def copy_traits ( self, other, traits = None, memo = None, copy = None ):
        ...
        traits : list of strings
            A list of trait attributes to copy. If **None** or unspecified, the
            set of names returned by `trait_names()` is used. If 'all' or an
            empty list, the set of names returned by 'all_trait_names()' is
            used.
        memo : dictionary
        ...
        copy : None | 'deep' | 'shallow'
            ...
            'copy' meta-data. A value of **None** means 'copy reference'.
    ...
    def clone_traits ( self, traits = None, memo = None, copy = None ):
        ...
        *traits* must be a list of the names of the trait attributes to be
        ...
        memo[ id( self ) ] = new
        new.copy_traits( self, traits, memo, copy )
        return new
    ...
    def edit_traits ( self, view       = None, parent  = None,
        ...
        ----------
        view : string
            The name of a **View** object that defines a user interface for
            editing trait attribute values of the current object. If not
            specified, the View object returned by `trait_view()` is used.
        parent : window handle
            A user interface component to use as the parent window for the
            object's UI window.
        kind : string
            The type of user interface window to create. The following are valid
            values:
                ...
                'modal'
                    ...
                    until the user clicks **Apply**, **Revert**, **OK**,
    ...
    def trait_view ( self, name = None, view_element = None ):
        ...
        ----------
        name : string
            A name of a view element
        view_element : a`ViewElement` object
            The view element to associate
        ...
        *view_element* is added to the `ViewElements` object associated with the
        current object's class, indexed by *name*.)
        ...
        view element. View elements retrieved by this function can be bound to a
        class attribute in the class definition, or can be associated with a
        name by a previous call to this method.
    ...
    def _trait_view ( cls, name, view_element, default_name, view_elements, 
        ...
        from neuroimaging.utils.enthought.traits.ui import View
    ...
    def default_traits_view ( self ):
        """ Returns the default traits view/name.
        """
    ...
    def configure_traits ( self, filename   = None, view       = None,
        ...
        """Creates and displays a modal dialog box for editing values of trait
        attributes, as if it were a complete, self-contained GUI application.

        Parameters
        ----------
        filename : string
            The name of a file that contains a pickled representation of the
            current object
        view : string
            The name of a **View** object that defines a user interface for
            editing trait attribute values of the current object. If not
        ...
        edit : boolean
            Flag indicating whether to display a user interface.
        context : object or dictionary
            A single object or a dictionary of string/object pairs, whose trait
            attributes are to be edited. If not specified, the current object is
            used
        handler : object
            ...
            **None**, the default handler for the GUI toolkit is used.
        ...
        if edit:
            from neuroimaging.utils.enthought.traits.ui import toolkit
            if context is None:
                context = self
    ...
    def editable_traits ( self ):
        ...
        """
        return self.__class__.class_editable_traits()
    ...
    def print_traits ( self, show_help = False ):
        ...
        ----------
        show_help : boolean
            Flag indicating whether to display additional descriptive
            information.
        """
    ...
    def on_trait_change ( self, handler, name = None, remove = False ):
        """Causes the object to invoke the specified *handler* whenever *name*
    ...
    def sync_trait ( self, trait_name, object, alias = None, mutual = True ):
        """Synchronizes the value of the specified trait attribute on *self*
        and *object*.

        Parameters
        ----------
        name : string
            Name of the trait attribute on ``self``
        object : object
            The object with which to synchronize values
        alias : string
            Name of the trait attribute on *other*; if **None** or omitted, same
            as *name*.
        mutual : boolean or integer
            Flag indicating whether synchronization is mutual (**True**) or
            one-way (**False**)

        Description
        -----------
        If *alias* is **None** or omitted, then the name string is used as the
        name of the trait attribute on both objects; otherwise *alias* is a
        string that specifies the name of the trait attribute on *other* that is
        to be synchronized with ``self.name``. If *mutual* is **True** (or
        non-zero), the synchronization is two-way. That is, any change to the
        specified trait attribute value of either object results in the same
        value being assigned to the corresponding trait attribute of the other.
        If *mutual* is **False** (or 0), then any change to ``self.name``
        causes the corresponding trait attribute of *object* to be updated, but
        not vice versa.
        """
        if alias is None:
            alias = trait_name
    ...
    def add_trait ( self, name, *trait ):
        """Adds a trait attribute called *name*, based on the trait definition
        *trait*.
        ...
        trait : string or list
            Trait definition for name

        Description
        -----------
        The *trait* argument can be a trait or a value that can be converted to
        a trait using the `Trait()` function; it can also be a list of traits or
        values. If more than one value is specified, it is equivalent to passing
        the entire list of values to the Trait() function.
        """
    ...
    def remove_trait ( self, name ):
        """Removes a trait attribute called *name*.
    ...
    def trait ( self, name, force = False ):
        """Returns the trait definition for the trait attribute whose name is
        specified by the string *name*.
        ...
        force : boolean
            Flag indicating whether to return a trait definition if *name* is
    ...
    def base_trait ( self, name ):
        """Returns the base trait definition for the trait attribute named
        *name*.
        ...
        Description
        -----------
        This method is similar to the `trait()` method, and only returns a
        different result in the case where the trait attribute defined by *name*
        is a delegate. In this case, the base_trait() method follows the
    ...
    def traits ( self, **metadata ):
        ...
        attributes of ``self`` that match the set of *metadata* criteria.
    ...
    def trait_names ( self, **metadata ):
        ...
        Description
        -----------
        This method is similar to the `traits()` method, but only returns the
        names of the matching trait attributes, not the trait definitions.
        """
        return self.__class__.class_trait_names( **metadata )
    ...
    def class_trait_names ( cls, **metadata ):
        ...
        """
        if len( metadata ) == 0:
            return cls.__base_traits__.keys()
