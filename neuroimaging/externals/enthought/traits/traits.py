...
def password_editor ( ):
    ...
    if PasswordEditor is None:
        from neuroimaging.externals.enthought.traits.ui.api import TextEditor
...
def code_editor ( ):
    ...
    if SourceCodeEditor is None:
        from neuroimaging.externals.enthought.traits.ui.api import CodeEditor
...
def html_editor ( ):
    ...
    if HTMLTextEditor is None:
        from neuroimaging.externals.enthought.traits.ui.api import HTMLEditor
...
def shell_editor ( ):
    ...
    if PythonShellEditor is None:
        from neuroimaging.externals.enthought.traits.ui.api import ShellEditor
...
class CTrait ( cTrait ):
    ...
    def get_editor ( self ):
        """ Returns the user interface editor associated with the trait.
        """
        from neuroimaging.externals.enthought.traits.ui.api import EditorFactory
...
def _Array ( dtype = None, shape = None, value = None, coerce = False,
    ...
    if shape is not None:
        ...
        if (len( shape ) == 2) and (metadata.get( 'editor' ) is None):
            from neuroimaging.externals.enthought.traits.ui.api import ArrayEditor
...
def WeakRef ( klass = 'neuroimaging.externals.enthought.traits.HasTraits', allow_none = False,
              **metadata ):
...
def File ( value = '', filter = None, auto_set = False, **metadata ):
    ...
    *value* or ''
    """
    from neuroimaging.externals.enthought.traits.ui.editors import FileEditor
...
def Directory ( value = '', auto_set = False, **metadata ):
    ...
    *value* or ''
    """
    from neuroimaging.externals.enthought.traits.ui.editors import DirectoryEditor
...
def Button ( label = '', image = None, style = 'button',
    ...
    image : neuroimaging.externals.enthought.pyface.ImageResource
    ...
    from neuroimaging.externals.enthought.traits.ui.api import ButtonEditor
...
def ToolbarButton ( label = '', image = None, style = 'toolbar',
    ...
    label : string
        The label for the button
    image : neuromimaging.externals.enthought.pyface.ImageResource
        An image to display on the button
    style : one of: 'button', 'radio', 'toolbar', 'checkbox'
        The style of button to display
    orientation : one of: 'horizontal', 'vertical'
...
def UIDebugger ( **metadata ):
    ...
    from neuroimaging.externals.enthought.traits.ui.wx.ui_debug_editor import ToolkitEditorFactory
...
def Trait ( *value_type, **metadata ):
    ...
    editor : instance of a subclass of neuromimaging.externals.enthought.traits.api.Editor
...
def Color ( *args, **metadata ):
    ...
    * an integer whose hexadecimal form is 0x*RRGGBB*, where *RR* is the red
    ...
    """
    from neuroimaging.externals.enthought.traits.ui.api import ColorTrait
...
def RGBColor ( *args, **metadata ):
    ...
    * An integer whose hexadecimal form is 0x*RRGGBB*, where *RR* is the red
    ...
    """
    from neuroimaging.externals.enthought.traits.ui.api import RGBColorTrait
...
def Font ( *args, **metadata ):
    ...
    * a string describing the font, including one or more of the font family,
    ...
    """
    from neuroimaging.externals.enthought.traits.ui.api import FontTrait
