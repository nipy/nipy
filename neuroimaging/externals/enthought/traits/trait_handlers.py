...
class TraitHandler ( object ):
    ...
    def get_editor ( self, trait ):
        ...
        if self.editor is None:
            from neuroimaging.external.enthought.traits.ui.api import TextEditor
...
class TraitRange ( TraitHandler ):
    ...
    **weight** trait attribute, which must be a non-negative float value.
    ...
    def get_editor ( self, trait ):
        ...
        if auto_set is None:
            auto_set = True
        from neuroimaging.external.enthought.traits.ui.api import RangeEditor
...
class TraitType ( TraitHandler ):
    ...
    def get_editor ( self, trait ):
        ...
        if self.aType is bool:
            if self.editor is None:
                from neuroimaging.external.enthought.traits.ui.api import BooleanEditor
...
class ThisClass ( TraitHandler ):
    ...
    **self**, and the elements of ListThis.
    ...
    def get_editor ( self, trait ):
        if self.editor is None:
            from neuroimaging.external.enthought.traits.ui.api import InstanceEditor
...
class TraitEnum ( TraitHandler ):
    ...
    def get_editor ( self, trait ):
        from neuroimaging.external.enthought.traits.ui.api import EnumEditor
...
class TraitCompound ( TraitHandler ):
    ...
    def get_editor ( self, trait ):
        from neuroimaging.external.enthought.traits.ui.api import TextEditor, CompoundEditor
...
class TraitTuple ( TraitHandler ):
    ...
    def get_editor ( self, trait ):
        from neuroimaging.external.enthought.traits.ui.api import TupleEditor
...
class TraitList ( TraitHandler ):
    ...
    def get_editor ( self, trait ):
        ...
        if isinstance( handler, TraitInstance ) and (trait.mode != 'list'):
            from neuroimaging.external.enthought.traits.api import HasTraits
            if issubclass( handler.aClass, HasTraits ):
                try:
                    object = handler.aClass()
                    from neuroimaging.external.enthought.traits.ui.table_column import ObjectColumn
                    from neuroimaging.external.enthought.traits.ui.table_filter import \
                         EvalFilterTemplate, RuleFilterTemplate, \
                         MenuFilterTemplate, EvalTableFilter
                    from neuroimaging.external.enthought.traits.ui.api import TableEditor
                    return TableEditor(
        ...
        from neuroimaging.external.enthought.traits.ui.api import ListEditor
