...
if fine_nose:
    from neuroimaging.externals.scipy.testing.nosetester import NoseTester as Tester
else:
    from neuroimaging.externals.scipy.testing.nulltester import NullTester as Tester
