...
import nipy.algorithms.utils.simul_multisubject_fmri_dataset as simul
from nipy.algorithms.spatial_models.bayesian_structural_analysis import\
    compute_landmarks
from nipy.algorithms.spatial_models.discrete_domain import grid_domain_from_shape
