...
if __name__ == '__main__':
    ...
    from enthought.traits import Event, List, Dict, Any, Int, Long, Float, Str
    from enthought.traits import Unicode, Complex, Bool, CInt, CLong, CFloat
    from enthought.traits import CStr, CUnicode, CComplex, CBool, false, true
    from enthought.traits import String, Password, File, Directory, Function
    from enthought.traits import Method, Class, Module, Type, This, self, Python
    from enthought.traits import ReadOnly, ListInt, ListFloat, ListStr
    from enthought.traits import ListUnicode, ListComplex, ListBool
    from enthought.traits import ListFunction, ListMethod, ListClass
    from enthought.traits import ListInstance, ListThis, DictStrAny, DictStrStr
    from enthought.traits import DictStrInt, DictStrLong, DictStrFloat
    from enthought.traits import DictStrBool,DictStrList
