...
import neuroimaging.extra.enthought.util.numerix

from neuroimaging.extra.enthought.util.numerix \
...
try:
    from neuroimaging.extra.enthought.util.numerix import Int64
except:
    Int64 = None
                    
try:
    from neuroimaging.extra.enthought.util.numerix import Int128
except:
    Int128 = None
                    
try:
    from neuroimaging.extra.enthought.util.numerix import Float128
except:
    Float128 = None
                    
try:
    from neuroimaging.extra.enthought.util.numerix import Complex128
except:
    Complex128 = None
