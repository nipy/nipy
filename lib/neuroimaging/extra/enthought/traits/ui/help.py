...
# Date: 02/04/2005
# Description: Define the help interface for displaying the help associated with
#              a traits UI View.
#------------------------------------------------------------------------------
...
def on_help_call ( new_show_help = None ):
    ...
    *function(info, control)*, where *info* is a UIInfo object for the current
    view, and *control* is the UI control that invokes the function (typically,
    a **Help** button). It is provided in case the help provider needs to 
    position the help window relative to the **Help** button. 
