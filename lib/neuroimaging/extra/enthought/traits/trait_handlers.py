...
class TraitRange ( TraitHandler ):
    ...
    **weight** trait attribute, which must be a non-negative float value.
    ...
    def get_editor ( self, trait ):
        ...
        if auto_set is None:
            auto_set = True
        from neuroimaging.extra.enthought.traits.ui import RangeEditor
...
class TraitType ( TraitHandler ):
    ...
    def get_editor ( self, trait ):
        ...
        if self.aType is bool:
            if self.editor is None:
                from neuroimaging.extra.enthought.traits.ui import BooleanEditor
...
class ThisClass ( TraitHandler ):
    ...
    def get_editor ( self, trait ):
        if self.editor is None:
            from neuroimaging.extra.enthought.traits.ui import InstanceEditor
...
class TraitEnum ( TraitHandler ):
    ...
    def get_editor ( self, trait ):
        from neuroimaging.extra.enthought.traits.ui import EnumEditor
...
class TraitCompound ( TraitHandler ):
    ...
    def get_editor ( self, trait ):
        from neuroimaging.extra.enthought.traits.ui import TextEditor, CompoundEditor
...
class TraitTuple ( TraitHandler ):
    ...
    def get_editor ( self, trait ):
        from neuroimaging.extra.enthought.traits.ui import TupleEditor
...
class TraitList ( TraitHandler ):
    ...
    def get_editor ( self, trait ):
        ...
        if isinstance( handler, TraitInstance ) and (trait.mode != 'list'):
            from neuroimaging.extra.enthought.traits import HasTraits
            if issubclass( handler.aClass, HasTraits ):
                try:
                    object = handler.aClass()
                    from neuroimaging.extra.enthought.traits.ui.table_column import ObjectColumn
                    from neuroimaging.extra.enthought.traits.ui.table_filter import \
        ...
        from neuroimaging.extra.enthought.traits.ui import ListEditor
