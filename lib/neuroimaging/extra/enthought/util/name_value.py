...
from neuroimaging.extra.enthought.traits import Any, HasTraits, Str, Trait, TraitDict
# from neuroimaging.extra.enthought.util.traits.editor.dict.table_editor import TableEditor
