...
from neuroimaging.extra.enthought.util.scipyx import arange, sqrt, argmax, zeros, nonzero, take, absolute
...
if __name__ == "__main__":
    from neuroimaging.extra.enthought.util.randomx import random
