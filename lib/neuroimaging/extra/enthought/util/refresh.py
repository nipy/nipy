...
class Refresher(object):
    ...
    def refresh(self):
        """ Find all out-of-date modules and reload functions end classes.
        """
        ...
        # 2. Find classes and functions that need to be updated.
        updates = {}
        for module in modules:            
            functions, classes = new_functions_and_classes_for_module(module,
                                                                      self.logger)
            if functions or classes:
                updates[module] = (functions, classes)
              
        if updates:
            
            # 3. find all the functions and clases in the system
            ...
            for module in updates:
                ...
                updated_functions, updated_classes = updates[module]                        
    ...
    def _refresh_classes(self, all_classes, updated_classes):
        ...
        for new_class in updated_classes:
            ...
            # remove the entry that matches this class.
            matched_classes.remove(new_class)
    ...
    def _refresh_functions(self, all_functions, updated_functions):
        ...
        for new_function in updated_functions:
            ...
            # remove the entry that matches this class.
            matched_functions.remove(new_function)
                   
            if len(matched_functions) == 0:
                # if no old versions are found, we don't have to do anything...
                pass
...
def function_and_class_names_in_file(file_name):
    """ Find the names of classes contained within a file.
        ...
        Example::
            ...
            >>> import neuroimaging.extra.enthought.util.refresh
