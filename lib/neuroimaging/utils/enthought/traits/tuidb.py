...
from neuroimaging.utils.enthought.traits \
    import HasPrivateTraits, Enum, Instance, List, Str, Button
    
from neuroimaging.utils.enthought.traits.trait_base \
    import traits_home                             
    
from neuroimaging.utils.enthought.traits.ui \
    import View, Item, SetEditor, Handler, HGroup
...
class TUIDB ( Handler ):
    ...
    view = View( [ Item( 'discard{}', editor = SetEditor(
                                           name               = 'all_items',
                 ...
                 id        = 'neuroimaging.utils.enthought.traits.ui.tuidb',
                 width     = 0.4,
                 height    = 0.3,
                 resizable = True,
                 buttons   = NoButtons )
