...
#menubar_trait = Instance( 'neuroimaging.utils.enthought.pyface.action.MenuBarManager',
#                          desc = 'the menu bar for the view' )

# The tool bar for the view:
#toolbar_trait = Instance( 'neuroimaging.utils.enthought.pyface.action.ToolBarManager',
...
#icon_trait = Instance( 'neuroimaging.utils.enthought.pyface.image_resource.ImageResource',
