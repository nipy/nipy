...
# Date:   08/25/2005
# Description: Define the various instance descriptors used by the instance
#              editor and instance editor factory classes.
#
...
class InstanceFactoryChoice ( InstanceChoiceItem ):
    ...
    # Indicates whether an instance compatible with this item can be drag and
    ...
    # Dictionary of argument to pass to 'klass' to create an instance:
    kw_args = Dict( Str, Any )
    
    # Does this item create new instances (override default value):
    is_factory = True
...
class InstanceDropChoice ( InstanceFactoryChoice ):
    ...
    # Indicates whether an instance compatible with this item can be drag and
    # dropped rather than created (override default value):
    droppable = True
    
    # Indicates whether the item can be selected by the user (override default
    # value):
    selectable = False
