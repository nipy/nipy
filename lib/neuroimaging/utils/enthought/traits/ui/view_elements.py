...
# Date: 10/18/2004
# Description: Define the ViewElements class used to define a (typically
#              class-based) hierarchical name space of related ViewElement
#              objects.
#
#              Normally there is a ViewElements object associated with each
#              traits-based class that contains all of the ViewElement objects
#              associated with the class. The ViewElements object is also linked
#              to the ViewElements objects of its associated class's parent
#              classes.
#
...
import neuroimaging.utils.enthought.traits.has_traits as has_traits
...
class SearchStackItem ( HasStrictTraits ):
    ...
    # Index into 'mro' list of ViewElements it was found in:
    context = Int
