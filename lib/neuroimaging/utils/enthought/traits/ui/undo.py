...
# Date: 10/07/2004
# Description: Undo/Redo history manager for Traits user interface support
#------------------------------------------------------------------------------
...
class UndoItem ( AbstractUndoItem ):
    ...
    old_value = Property            # Old value of the changed trait 
    new_value = Property            # New value of the changed trait
