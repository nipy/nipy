...
# Date: 12/13/2004
# Description: Numeric related trait definitions.
#------------------------------------------------------------------------------
...
import neuroimaging.utils.enthought.util.numerix

from neuroimaging.utils.enthought.util.numerix \
     import array, asarray, zeros, Character, UnsignedInt8, Int, Int0, \
     Int8, Int16, Int32, Float, Float0, Float8, Float16, Float32, \
     Float64, Complex, Complex0, Complex8, Complex16, Complex32, \
     Complex64, PyObject
                    
try:
    from neuroimaging.utils.enthought.util.numerix import Int64
except:
    Int64 = None
                    
try:
    from neuroimaging.utils.enthought.util.numerix import Int128
except:
    Int128 = None
                    
try:
    from neuroimaging.utils.enthought.util.numerix import Float128
except:
    Float128 = None
                    
try:
    from neuroimaging.utils.enthought.util.numerix import Complex128
except:
    Complex128 = None
