...
def called_from ( levels = 1, context = 1 ):
    print '***** Deprecated.  Please use neuroimaging.utils.enthought.debug.called_from'
...
def test_suite(level=1):
    import neuroimaging.utils.enthought.util
    import neuroimaging.utils.enthought.util.testingx as testing
    return testing.harvest_test_suites(neuroimaging.utils.enthought.util,level=level)
