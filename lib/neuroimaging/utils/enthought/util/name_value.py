...
from neuroimaging.utils.enthought.traits import Any, HasTraits, Str, Trait, TraitDict
# from neuroimaging.utils.enthought.util.traits.editor.dict.table_editor import TableEditor
