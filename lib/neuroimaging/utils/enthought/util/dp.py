...
from neuroimaging.utils.enthought.util.scipyx import arange, sqrt, argmax, zeros, nonzero, take, absolute
...
if __name__ == "__main__":
    from neuroimaging.utils.enthought.util.randomx import random
